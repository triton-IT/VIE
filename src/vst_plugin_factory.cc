...
namespace live::tritone::vie::vst {	
	constexpr const char *kVersion = "0.0.0.1";
	constexpr const char *kPluginName = "Vie";
	constexpr const char *kCompanyName = "tritone.live";
	constexpr const char *kCompanyUrl = "https://tritone.live";
	constexpr const char *kCompanyEmail = "contact@tritone.live";

	vst_plugin_factory::vst_plugin_factory() : nb_ref_(0) {
		strcpy(factory_info_.vendor, kCompanyName);
		strcpy(factory_info_.url, kCompanyUrl);
		strcpy(factory_info_.email, kCompanyEmail);
