...
constexpr const char* company_url = "https://tritone.live";
constexpr const char* company_email = "contact@tritone.live";

namespace live::tritone::vie {
	//Note frequency offset is 1.059463094359295264561825
	constexpr float midi_notes_frequencies[] = {
