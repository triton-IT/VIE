Opal.modules["eVe/eVe/lib/eVe/graphics/matrix"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$initialize', function $$initialize(params) {
      ...
      self.matrix = self.$grab(matrix_parent).$box($hash2(["overflow", "color", "atome_id", "name"], {"overflow": "auto", "color": background_color, "atome_id": self.id, "name": params['$[]']("name")}));
      ...
      while ($truthy($rb_lt(cell_number, self.number_of_cells))) {
        ...
        self.matrix.$box($hash2(["color", "atome_id", "overflow"], {"color": "red", "atome_id": $rb_plus(self.matrix_name, "_" + (cell_number)), "overflow": "hidden"}).$merge(style));
...
Opal.modules["www/public/medias/projects/vie/vie_utils"] = function(Opal) {/* Generated by Opal 1.5.1 */
  var self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, $hash2 = Opal.hash2, $def = Opal.def, $rb_times = Opal.rb_times, $send = Opal.send, $rb_plus = Opal.rb_plus, $truthy = Opal.truthy, $rb_divide = Opal.rb_divide, $rb_gt = Opal.rb_gt, $eqeq = Opal.eqeq, $rb_minus = Opal.rb_minus, $to_ary = Opal.to_ary;

  Opal.add_stubs('grab,box,merge,[],data,over,cells,selected,animate,*,atome_id,wait,+,set,clear,text,each,get_cell,activate_cell,convert,/,>,==,-,size=,resize_matrix,center,matrix,resize_html,resize_action,color,new,drop,fill_cell,touch,nil?,call,child,delete,x=,deactivate_cell,drag,virtual_event,to_n,resize_playground,image,size,new_playground,list,each_with_index');
  ...
  $def(self, '$activate_cell', function $$activate_cell() {
    var self = this, style = nil, duration = nil, vie_playground = nil;
  ...
  return $def(self, '$new_project', function $$new_project(data) {
    ...
    $send(data['$[]']("actions"), 'each_with_index', [], function $$15($mlhs_tmp1, index){var $a, $b, self = $$15.$$s == null ? this : $$15.$$s, action_id = nil, action_label = nil, new_action = nil;
      ...
      new_action = self.$text($hash2(["id", "content"], {"id": action_id, "content": action_label['$[]'](self.language)}));
...
Opal.modules["www/public/medias/projects/vie/vie_add_on"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  Opal.add_stubs('inspect,delete,[],[]=,to_i,each,new,cloner,grab,atome_id,state,merge,box,alert,==,each_with_index,data,shadow,height,width,-,*,center,y,+,color,text,/,image,touch,animate,cells,!=,selected,fill_cell,drag,start,end');
  ...
  return $def(self, '$list', function $$list(items, style) {
    ...
    style = $hash2(["atome_id", "background", "line_background", "parent", "line_height", "line_spacing", "margin", "width"], {"atome_id": "my_list", "background": "transparent", "line_background": "white", "parent": "view", "line_height": 33, "line_spacing": 9, "margin": 3, "width": 99}).$merge(style);
    ...
    return $send(items, 'each_with_index', [], function $$3($mlhs_tmp1, index){var $a, $b, self = $$3.$$s == null ? this : $$3.$$s, data_id = nil, content = nil, item = nil, vie_style = nil, current_color = nil;
      ...
      item.$text($hash2(["content", "xx", "y", "visual"], {"content": content['$[]']("label")['$[]'](self.language), "xx": 6, "y": 6, "visual": $rb_divide(style['$[]']("line_height"), 3)}));
      item.$image($hash2(["content", "size", "center", "x", "z"], {"content": content['$[]']("icon"), "size": $rb_times(style['$[]']("line_height"), 0.6), "center": "y", "x": 3, "z": 6}));
      ...
      $send(item, 'touch', [$hash2(["option"], {"option": "up"})], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s, vie_style = nil;
        ...
        vie_style = self.$grab("vie_style");
        $send(self.$grab("vie_matrix").$data().$cells(), 'each', [], function $$6(cell){var self = $$6.$$s == null ? this : $$6.$$s;

          
          
          if (cell == null) cell = nil;;
          if (($truthy(cell.$selected()) && ($neqeq(self.$state(), "dragged")))) {
            return self.$fill_cell(cell, data_id, vie_style)
          } else {
            return nil
          };}, {$$arity: 1, $$s: self});
...
Opal.modules["www/public/medias/projects/vie/vie_style"] = function(Opal) {/* Generated by Opal 1.5.1 */
  ...
  ref_size = 69;
  color_theme = $hash2(["back_color", "base_color", "cell_color", "selected_color", "flash_color", "matrix_background", "text_color"], {"back_color": $hash2(["red", "green", "blue", "alpha"], {"red": 0.2, "green": 0.2, "blue": 0.2, "alpha": 0.6}), "base_color": $hash2(["red", "green", "blue", "alpha"], {"red": 0.15, "green": 0.15, "blue": 0.15, "alpha": 1}), "cell_color": $hash2(["red", "green", "blue", "alpha"], {"red": 0.18, "green": 0.18, "blue": 0.18, "alpha": 1}), "selected_color": $hash2(["red", "green", "blue", "alpha"], {"red": 0, "green": 0.9, "blue": 0.3, "alpha": 0.2}), "flash_color": $hash2(["red", "green", "blue", "alpha"], {"red": 0.2, "green": 1, "blue": 0.6, "alpha": 0.9}), "matrix_background": $hash2(["red", "green", "blue", "alpha"], {"red": 1, "green": 0.3, "blue": 0.3, "alpha": 0}), "text_color": $hash2(["red", "green", "blue", "alpha"], {"red": 0.69, "green": 0.69, "blue": 0.69, "alpha": 1})});
  vie_style = $hash2(["ref_size", "animation_duration", "matrix_background", "matrix", "cell", "label", "cell_selected", "flash_color", "lines", "alternated_lines", "navigator", "inspector", "details", "action", "matrix_shell", "title", "title_label", "module", "module_selected"], {"ref_size": ref_size, "animation_duration": 0.3, "matrix_background": color_theme['$[]']("matrix_background"), "matrix": $hash2(["color"], {"color": color_theme['$[]']("back_color")}), "cell": $hash2(["color"], {"color": color_theme['$[]']("cell_color")}), "label": $hash2(["color", "visual", "center"], {"color": color_theme['$[]']("text_color"), "visual": 12, "center": true}), "cell_selected": $hash2(["color"], {"color": color_theme['$[]']("selected_color")}), "flash_color": color_theme['$[]']("flash_color"), "lines": $hash2(["height", "color"], {"height": 33, "color": color_theme['$[]']("base_color")}), "alternated_lines": $hash2(["height", "color"], {"height": 33, "color": color_theme['$[]']("selected_color")}), "navigator": $hash2(["width", "height", "x", "y", "yy", "color", "shadow", "z"], {"width": ref_size, "height": "auto", "x": 0, "y": ref_size, "yy": ref_size, "color": color_theme['$[]']("base_color"), "shadow": $hash2(["bounding"], {"bounding": true}), "z": 1}), "inspector": $hash2(["width", "height", "xx", "y", "yy", "color", "shadow", "z"], {"width": ref_size, "height": "auto", "xx": 0, "y": ref_size, "yy": ref_size, "color": color_theme['$[]']("base_color"), "shadow": $hash2(["bounding"], {"bounding": true}), "z": 1}), "details": $hash2(["width", "height", "x", "yy", "xx", "color", "shadow", "z"], {"width": "auto", "height": ref_size, "x": 0, "yy": 0, "xx": 0, "color": color_theme['$[]']("base_color"), "shadow": $hash2(["bounding"], {"bounding": true}), "z": 2}), "action": $hash2(["width", "height", "x", "y", "xx", "color", "shadow", "z"], {"width": "auto", "height": ref_size, "x": 0, "y": 0, "xx": 0, "color": color_theme['$[]']("base_color"), "shadow": $hash2(["bounding"], {"bounding": true}), "z": 2}), "matrix_shell": $hash2(["center", "y", "yy", "xx", "color", "z"], {"center": true, "y": ref_size, "yy": ref_size, "xx": ref_size, "color": color_theme['$[]']("base_color"), "z": 0}), "title": $hash2(["width", "height", "center", "y", "color", "shadow", "z", "smooth"], {"width": 333, "height": $rb_divide(ref_size, 3), "center": $hash2(["axis", "dynamic"], {"axis": "x", "dynamic": true}), "y": 0, "color": color_theme['$[]']("base_color"), "shadow": $hash2(["bounding"], {"bounding": true}), "z": 3, "smooth": [0, 0, 9, 9]}), "title_label": $hash2(["visual", "y", "center"], {"visual": 15, "y": 3, "center": "x"}), "module": $hash2(["color"], {"color": color_theme['$[]']("base_color")}), "module_selected": $hash2(["color", "shadow"], {"color": color_theme['$[]']("selected_color"), "shadow": $hash2(["bounding"], {"bounding": true})})});
...
Opal.modules["www/public/medias/projects/vie/index"] = function(Opal) {/* Generated by Opal 1.5.1 */
  var self = Opal.top, nil = Opal.nil, $hash2 = Opal.hash2, $def = Opal.def, $send = Opal.send, $truthy = Opal.truthy, modules = nil, modules_style = nil, cells = nil, actions = nil, actions_style = nil, test_project = nil, test_project2 = nil, projects = nil, new$ = nil, save = nil, load = nil, active_module = nil, set_module_value = nil, link_modules = nil, set_module_name = nil, undo = nil, re_do = nil;

  Opal.add_stubs('require,[],grab,init_vie,new_project,puts,send_to_engine,to_json,key,ctrl_key,stop_propagation,stop_immediate_propagation,prevent_default,key_code,data,each,cells,selected,deactivate_cell,activate_cell');
  ...
  modules = $hash2(["test", "utils", "hello"], {"test": $hash2(["data", "icon", "label", "type", "value", "parameter", "ins", "outs"], {"data": "wave", "icon": "wait", "label": $hash2(["english", "french"], {"english": "sin", "french": "arr"}), "type": "unit", "value": 0.2, "parameter": "frequency", "ins": [], "outs": []}), "utils": $hash2(["data", "icon", "label", "type"], {"data": "filter", "icon": "run", "label": $hash2(["english", "french"], {"english": "help", "french": "aide"}), "type": "unit"}), "hello": $hash2(["data", "icon", "label", "type", "children", "parameters"], {"data": "hello", "icon": "action", "label": $hash2(["english", "french"], {"english": "action", "french": "utils"}), "type": "container", "children": ["matrix_2", "matrix_3"], "parameters": $hash2(["matrix_2"], {"matrix_2": ["matrix_2_3"]})})});
  ...
  return $send(self.$grab("view"), 'key', [$hash2(["options"], {"options": "down"})], function $$1(evt){var self = $$1.$$s == null ? this : $$1.$$s, activated = nil, current_matrix = nil;
