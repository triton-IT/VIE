...
Opal.queue(function (Opal) {/* Generated by Opal 1.7.2 */
    ...
    $def(self, '$action_folder', function $$action_folder() {
        ...
        self.$send_to_controller({ "action": "save_project" });
        self.$send_to_controller({ "action": "save_project_as" });
        self.$send_to_controller({ "action": "load_project", "body": {"path": "c:/dev/triton-IT/VIE/src/assets/config/default_instrument.json"} });
        self.$send_to_controller({ "action": "get_modules" });
        self.$send_to_controller({ "action": "add_module" });
