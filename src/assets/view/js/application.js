Opal.modules["build/medias/rubies/examples/_vie"] = function (Opal) {/* Generated by Opal 1.6.0 */
    var $hash2 = Opal.hash2, $send = Opal.send, $rb_plus = Opal.rb_plus, $rb_times = Opal.rb_times,
        $rb_divide = Opal.rb_divide, $rb_minus = Opal.rb_minus, $def = Opal.def, self = Opal.top, $nesting = [],
        $$ = Opal.$r($nesting), nil = Opal.nil, a = nil, hash_test = nil, json_test = nil;

    Opal.add_stubs('new,each,[],+,*,to_i,text,touch,puts,circle,drag,/,-,to_json,parse,get_vie_module');

    a = $hash2(["modules", "links"], {
        "modules": [$hash2(["id", "name", "type_id", "active", "input_slots", "output_slots", "position"], {
            "id": "90be7add-12fd-476e-a267-c4ea65cd0bad",
            "name": "Midi in",
            "type_id": "midi",
            "active": "true",
            "input_slots": [$hash2(["id", "name", "unit", "value"], {
                "id": "948151e4-93c5-428f-a2e9-01f560592a7d",
                "name": "active",
                "unit": "",
                "value": 1
            })],
            "output_slots": [$hash2(["id", "name", "unit"], {
                "id": "394119f0-886e-4fae-8ae7-d3b187266760",
                "name": "Midi out",
                "unit": ""
            })],
            "position": $hash2(["x", "y", "z"], {"x": 0, "y": 0, "z": 0})
        }), $hash2(["id", "name", "type_id", "active", "input_slots", "output_slots", "position"], {
            ...
            "position": $hash2(["x", "y", "z"], {"x": 1, "y": 0, "z": 0})
        }), $hash2(["id", "name", "type_id", "active", "input_slots", "output_slots", "position"], {
            ...
            "position": $hash2(["x", "y", "z"], {"x": 2, "y": 0, "z": 0})
        }), $hash2(["id", "name", "type_id", "active", "input_slots", "output_slots", "position"], {
            ...
            "output_slots": [],
            "position": $hash2(["x", "y", "z"], {"x": 3, "y": 0, "z": 0})
        })],
        "links": [$hash2(["id", "sourceComponentId", "sourceOutputSlotId", "targetComponentId", "targetInputSlotId", "active"], {
            ...
            "active": "true"
        }), $hash2(["id", "sourceComponentId", "sourceOutputSlotId", "targetComponentId", "targetInputSlotId", "active"], {
    ...
    $$('Atome').$new($hash2(["color"], {
        "color": $hash2(["renderers", "id", "type", "parents", "children", "left", "top", "red", "green", "blue", "alpha"], {
            "renderers": ["browser"],
            "id": "orange_col",
            "type": "color",
            "parents": [],
    ...
    $def(self, '$get_vie_module', function $$get_vie_module(list) {
        ...
        $send(list['$[]']("modules"), 'each', [], function $$1(properties, value) {
            var self = $$1.$$s == null ? this : $$1.$$s, module_id = nil, module_name = nil, module_active = nil,
                module_position = nil, module_input_slots = nil, module_output_slots = nil, left_pos = nil,
                top_pos = nil, a = nil, slider = nil;
            ...
            a = $$('Atome').$new($hash2(["shape"], {
                "shape": $hash2(["type", "renderers", "id", "parents", "children", "color", "left", "top", "width", "height"], {
                    "type": "shape",
                    "renderers": ["browser"],
                    "id": module_id,
                    "parents": ["view"],
            ...
            a.$text($hash2(["data", "visual", "color", "center", "width", "height"], {
                "data": module_id,
                "visual": $hash2(["size"], {"size": 12}),
                "color": "black",
                "center": "horizontal",
                "width": 120,
                "height": 120
            }));
            $send(a, 'touch', [true], function $$2() {
                var self = $$2.$$s == null ? this : $$2.$$s;

                return self.$puts(a)
            }, {$$arity: 0, $$s: self});
            slider = a.$circle($hash2(["width", "height", "top", "left"], {
                "width": 20,
                "height": 20,
                "top": 15,
                "left": 15
            }));
            return $send(slider, 'drag', [$hash2(["move", "inertia", "lock", "constraint"], {
                "move": true,
                "inertia": true,
                "lock": "x",
                "constraint": "parent"
                ...
                send_to_controller(module_id, 0, msg_value);
            }, 1);
        }, {$$arity: 2, $$s: self});
        return list['$[]']("links");
    }, 1);
