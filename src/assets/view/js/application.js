...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  Opal.add_stubs('puts,to_json,parse,controller_listener,require,element,box,[],vie_styles,grab,text,merge,matrix,detached,width,right,each_with_index,value,children,touch,cell,data,[]=,include?,id,each,attached,<<,==,clear_zone,vivify,wait,create_matrix,set_title,+,*,display_svg,get_icon,send,fill_toolzone,delete,children=,top,remove_active,controller_sender,alert,list,each_value,tool_list,svg_fetch,drag,/,height');
