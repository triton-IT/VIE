...
void VulkanEngine::init(void* parent)
{
	...
	//SDL_Window* w = SDL_CreateWindowFrom(parent);
...
void VulkanEngine::init_pipelines()
{
	...
	if (!load_shader_module("assets/default_lit.frag.spv", &colorMeshShader))
	{
		std::cout << "Error when building the colored mesh shader" << std::endl;
	}

	VkShaderModule texturedMeshShader;
	if (!load_shader_module("assets/textured_lit.frag.spv", &texturedMeshShader))
	{
		std::cout << "Error when building the colored mesh shader" << std::endl;
	}

	VkShaderModule meshVertShader;
	if (!load_shader_module("assets/tri_mesh_ssbo.vert.spv", &meshVertShader))
	{
