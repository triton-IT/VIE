...
Opal.modules["application/fake_data"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  return $def(self, '$modules_list', function $$modules_list() {
...
Opal.modules["application/ui_template"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  Opal.add_stubs('box,grab,display_svg,[],vie_styles,element,merge,+,*,get_icon,id,tool_events,each_with_index,add_icons_to_tool_zone,matrix,right,data');
  ...
  $def(self, '$create_matrix', function $$create_matrix(id) {
    var self = this, center = nil, matrix_style = nil, modules = nil;

    
    center = self.$grab("center");
    matrix_style = self.$vie_styles()['$[]']("matrix_style").$merge($hash2(["id", "cells"], {"id": "matrix_cell_" + (id), "cells": $hash2(["particles"], {"particles": $hash2(["margin", "smooth", "color", "shadow"], {"margin": 9, "smooth": 3, "color": self.$vie_styles()['$[]']("cell_color"), "shadow": $hash2(["blur", "left", "top", "id", "red", "green", "blue", "alpha"], {"blur": 9, "left": 3, "top": 3, "id": "default_cell_shadow", "red": 0, "green": 0, "blue": 0, "alpha": 0.3})})})}));
...
Opal.modules["application/utilities"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $def = Opal.def, $truthy = Opal.truthy, $hash2 = Opal.hash2, $eqeq = Opal.eqeq, self = Opal.top, nil = Opal.nil;

  Opal.add_stubs('data,grab,[],debug,puts,text,detach_cell_color,[]=,==,clear_zone,link_cells');
  ...
  $def(self, '$link_cells', function $$link_cells(current_matrix, inspector, source_cell, target_cell) {
    ...
    return self.$detach_cell_color(current_matrix, source_cell, target_cell);
  });
  return $def(self, '$test_link_cell', function $$test_link_cell(current_matrix, inspector, index) {
...
Opal.modules["application/callbacks"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $send = Opal.send, $hash2 = Opal.hash2, $truthy = Opal.truthy, $def = Opal.def, $rb_divide = Opal.rb_divide, self = Opal.top, nil = Opal.nil;

  Opal.add_stubs('each,text,grab,empty?,body,[],data,set_title,log,display_svg,box,id,/,width,height,materials,delete,tool_list,place_module_on_slot,svg_fetch');
  ...
  $def(self, '$place_module_on_slot', function $$place_module_on_slot(module_found) {
  ...
  return $def(self, '$insert_module_callback', function $$insert_module_callback(module_id) {
    ...
    return $send(self.$grab("selected").$data(), 'each', [], function $$3(module_id_found){var self = $$3.$$s == null ? this : $$3.$$s, module_found = nil, tool_found = nil, tool_color = nil;
      ...
      $send(module_found.$materials(), 'each', [], function $$4(child_found){var $a, self = $$4.$$s == null ? this : $$4.$$s;
      ...
      tool_color = "orange";
      self.$place_module_on_slot(module_found);
...
Opal.modules["application/events"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $send = Opal.send, $return_val = Opal.return_val, $def = Opal.def, self = Opal.top, nil = Opal.nil;

  Opal.add_stubs('touch,log,data,grab,[]=,over,detached,attached,wait,cell,attach_cell_color,[],context,test_link_cell,drop,each_with_index,cells,cells_over,cell_touch_down,cells_long_touch,cells_up_touch,cells_dropped_item,action_router');
  ...
  $def(self, '$cells_up_touch', function $$cells_up_touch(module_slot, current_matrix, inspector, index) {
    ...
    return $send(module_slot, 'touch', ["up"], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s;

      
      switch (self.$context()['$[]']("mode")) {
        case "default":
          return self.$test_link_cell(current_matrix, inspector, index)
        case "edit":
          return nil
        case "select":
          return nil
  ...
  $def(self, '$cells_dropped_item', function $$cells_dropped_item(module_slot) {
    ...
    return $send(module_slot, 'drop', [true], function $$6(event_content){var self = $$6.$$s == null ? this : $$6.$$s;
      ...
      return self.$log("received : " + (event_content));}, {$$s: self})
  });
...
Opal.modules["application/actions"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  $def(self, '$action_router', function $$action_router(id_found, options) {
    ...
    return self.$log("=> mode activated: " + (self.$grab("context").$data()) + "\n\n" + "=> function call : action_" + (id_found));
  });
...
Opal.modules["application/demo_methods"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  Opal.add_stubs('log,[],vie_styles,+,*,each_value,modules_list,box,grab,merge,svg_fetch,id,depth,drag,touch,left,top,attach,send,sort,list,get_settings,get_modules');
  return (function($base, $super, $parent_nesting) {
    ...
    $defs(self, '$get_modules', function $$get_modules() {
      ...
      icon_spacing = $rb_plus(self.$vie_styles()['$[]']("support_style")['$[]']("height"), $rb_times(margin, 2));
      index = 0;
      return $send(self.$modules_list(), 'each_value', [], function $$1(data){var self = $$1.$$s == null ? this : $$1.$$s, icon_found = nil, action_found = nil, id_found = nil, support = nil;
...
;
    ...
    $defs(self, '$get_settings', function $$get_settings() {
      var self = this, inspector = nil, item_to_list = nil;

      
      self.$log("create the get_settings callback here");
      inspector = self.$grab("inspector");
      ...
      $send(inspector, 'sort', [true], function $$6(el){
        
        if (el == null) el = nil;
        return nil;});
      return inspector.$list($hash2(["listing", "code", "style"], {"listing": item_to_list, "code": "load_modules", "style": $hash2(["colors", "width", "left", "right", "height", "items"], {"colors": ["gray", "white"], "width": "auto", "left": 0, "right": 0, "height": 15, "items": $hash2(["color", "size", "align", "margin"], {"color": "orange", "size": 36, "align": "left", "margin": 3})})}));
    });
    return $defs(self, '$controller_sender', function $$controller_sender(action) {
      var self = this, action_found = nil;

      
      action_found = action['$[]']("action");
      self.$log("controller_sender, received: " + (action));
      
      switch (action_found) {
        case "get_projects":
          return ""
        case "get_settings":
          return $$('Atome').$get_settings()
        case "get_modules":
...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.3 */
  var $hash2 = Opal.hash2, $send = Opal.send, $def = Opal.def, self = Opal.top, nil = Opal.nil, default_project_name = nil, tools_list = nil, current_matrix_id = nil, current_matrix = nil;

  Opal.add_stubs('require,[]=,data,grab,attached,text,merge,[],vie_styles,fill_tool_zone,create_matrix,matrix_events,each,materials,delete,detached');
  ...
  $def(self, '$clear_zone', function $$clear_zone(zone) {
    ...
    $send(zone.$materials(), 'each', [], function $$1(child_found){var $a, self = $$1.$$s == null ? this : $$1.$$s;
  ...
  return $def(self, '$remove_active', function $$remove_active(items) {
    ...
    return $send(items, 'each', [], function $$2(id_found, _properties){var $a, $b, self = $$2.$$s == null ? this : $$2.$$s;
