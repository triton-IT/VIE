...
Opal.modules["application/ui_template"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  $def(self, '$add_icons_to_tool_zone', function $$add_icons_to_tool_zone(tool, index, tool_style) {
    var self = this, tool_name = nil, svg_color = nil, support_style = nil, icon_spacing = nil, margin = nil, vector_data = nil, support = nil, options = nil;
...
Opal.modules["application/events"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $send = Opal.send, $eqeq = Opal.eqeq, $def = Opal.def, self = Opal.top, nil = Opal.nil;

  Opal.add_stubs('touch,[],context,grab,data,each,cells,==,tag,log,deselect_cell,select_cell,[]=,over,detached,attached,wait,cell,attach_cell_color,request_link_cell,drop,id,each_with_index,cells_over,cell_touch_down,cells_long_touch,cells_up_touch,cells_dropped_item,action_touch_router,action_long_touch_router');
  ...
  $def(self, '$cells_dropped_item', function $$cells_dropped_item(module_slot) {
    ...
    return $send(module_slot, 'drop', [true], function $$8(event_content){var self = $$8.$$s == null ? this : $$8.$$s;
...
Opal.modules["application/demo_methods"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $klass = Opal.klass, $rb_plus = Opal.rb_plus, $rb_times = Opal.rb_times, $send = Opal.send, $hash2 = Opal.hash2, $defs = Opal.defs, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('[],vie_styles,+,*,each_value,fake_modules_list,get_icon,vector,grab,merge,depth,drag,touch,left,top,id,attach,log,new_project_callback,fake_new_project_data,get_projects_callback,fake_project_list_data,load_project_callback,fake_project_data,get_settings_callback,get_modules');
  return (function($base, $super, $parent_nesting) {
    ...
    $defs(self, '$get_modules', function $$get_modules() {
      ...
      icon_spacing = $rb_plus(self.$vie_styles()['$[]']("support_style")['$[]']("height"), $rb_times(margin, 2));
      index = 0;
      return $send(self.$fake_modules_list(), 'each_value', [], function $$1(data){var self = $$1.$$s == null ? this : $$1.$$s, module_name = nil, icon_found = nil, module_id = nil, support = nil;
        ...
        $send(support, 'drag', ["start"], function $$4(){var id_found = nil, left_found = nil, top_found = nil;
...
;
        ...
        return $send(support, 'drag', ["end"], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s;
