...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  Opal.add_stubs('to_json,[],text,grab,parse,send,controller_listener,require,element,box,vie_styles,display_svg,merge,matrix,detached,width,right,each_with_index,materials,touch,cell,puts,data,[]=,include?,id,each,attached,<<,==,clear_zone,vivify,wait,create_matrix,set_title,+,*,get_icon,fill_toolzone,delete,top,remove_active,controller_sender,dummy_listener,data_for_test,alert,list,each_value,tool_list,svg_fetch,drag,/,height');
...
Opal.Object.$response_listener(response)
  ...
  $def(self, '$action_load', function $$action_load() {
    ...
    self.$controller_sender($hash2(["action"], {"action": "get_projects"}));
    return self.$dummy_listener(self.$data_for_test());
  });
