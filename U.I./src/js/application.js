...
Opal.modules["sliders"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  button = self.$box((new Map([["smooth", 6], ["left", 55], ["top", 160], ["color", (new Map([["red", 0.3], ["green", 0.3], ["blue", 0.3]]))], ["id", "my_box"]])));
  ...
  slider = self.$box((new Map([["width", 333], ["height", 25], ["top", 45], ["left", 55], ["smooth", 9], ["color", (new Map([["red", 0.3], ["green", 0.3], ["blue", 0.3]]))]])));
  ...
  label = self.$text((new Map([["data", 0], ["top", 69], ["left", 69], ["component", (new Map([["size", 12]]))], ["color", "gray"]])));
  ...
  support = self.$box((new Map([["top", 300], ["left", 55], ["width", 300], ["height", 40], ["smooth", 9], ["color", (new Map([["red", 0.3], ["green", 0.3], ["blue", 0.3]]))], ["id", "support"]])));
...
Opal.queue(function(Opal) {/* Generated by Opal 1.8.2 */
  var self = Opal.top, nil = Opal.nil, toolbox = nil, inspector = nil, contextual = nil, details = nil, light_box = nil;

  Opal.add_stubs('require,console,box,matrix');
  ...
  self.$console(true);
  toolbox = self.$box((new Map([["id", "toolbox"], ["top", 0], ["bottom", 0], ["height", "auto"], ["width", "3%"], ["left", 0]])));
  inspector = self.$box((new Map([["id", "inspector"], ["top", 0], ["bottom", 0], ["height", "auto"], ["width", "3%"], ["right", 0], ["left", "auto"]])));
  contextual = self.$box((new Map([["id", "infos"], ["top", 0], ["height", "3%"], ["width", "auto"], ["right", 0], ["left", 0]])));
  details = self.$box((new Map([["id", "infos"], ["bottom", 0], ["top", "auto"], ["height", "12%"], ["width", "auto"], ["right", 0], ["left", 0]])));
  return (light_box = self.$matrix((new Map([["center", true], ["width", 150], ["height", 120], ["color", "red"]]))));
});
