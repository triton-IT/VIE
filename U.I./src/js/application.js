...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.3 */
  var $def = Opal.def, $send = Opal.send, $hash2 = Opal.hash2, $eqeq = Opal.eqeq, $truthy = Opal.truthy, $rb_plus = Opal.rb_plus, $rb_times = Opal.rb_times, $to_ary = Opal.to_ary, $rb_divide = Opal.rb_divide, $slice = Opal.slice, self = Opal.top, nil = Opal.nil, default_project_name = nil, logo_color = nil, logo = nil, module_box = nil;

  Opal.add_stubs('to_json,each,text,grab,==,length,send,controller_listener,require,element,box,[],vie_styles,display_svg,merge,matrix,detached,width,right,each_with_index,materials,touch,cell,puts,data,[]=,include?,id,attached,<<,clear_zone,vivify,wait,create_matrix,set_title,+,*,get_icon,fill_toolzone,delete,top,remove_active,controller_sender,alert,list,each_value,tool_list,svg_fetch,drag,/,height,new_svg_fetch,action_get_modules');
...
;
  ...
  $def(self, '$get_modules_callback', function $$get_modules_callback(body) {
    ...
    $send(body, 'each', [], function $$20(module_found){var self = $$20.$$s == null ? this : $$20.$$s, content = nil;
      ...
      self.$new_svg_fetch(module_found["icon"], "lightgray", "get_modules_box");
      return self.$grab("inspector").$text($hash2(["data", "top", "visual"], {"data": content, "top": 60, "visual": $hash2(["size"], {"size": 12})}));}, {$$s: self});
    if (!$eqeq(body.$length(), 0)) {
      return nil
    };
  ...
  module_box = self.$box($hash2(["id", "bottom"], {"id": "get_modules_box", "bottom": 0}));
