...
Opal.modules["application/experimental_api"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["application/version"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  self.$puts("vie version: 0.003");
  return self.$puts("v-UIe version: 0.002");
};
...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  Opal.add_stubs('puts,to_json,parse,controller_listener,require,element,box,[],vie_styles,grab,display_svg,text,merge,matrix,detached,width,right,each_with_index,value,children,touch,cell,data,[]=,include?,id,each,attached,<<,==,clear_zone,vivify,wait,create_matrix,set_title,+,*,get_icon,send,fill_toolzone,delete,children=,top,remove_active,controller_sender,alert,list,each_value,tool_list,svg_fetch,drag,/,height');
  
  
  $def(self, '$controller_test', function $$controller_test(msg) {
    var self = this;
