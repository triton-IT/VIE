...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  Opal.add_stubs('puts,to_json,parse,controller_listener,require,element,box,[],vie_styles,grab,display_svg,text,merge,matrix,detached,width,right,each_with_index,materials,touch,cell,data,[]=,include?,id,each,attached,<<,==,clear_zone,vivify,wait,create_matrix,set_title,+,*,get_icon,send,fill_toolzone,delete,materials=,top,remove_active,controller_sender,alert,list,each_value,tool_list,svg_fetch,drag,/,height');
...
// write code here:
  ...
  $def(self, '$clear_zone', function $$clear_zone(zone) {
    ...
    return ($a = [[]], $send(zone, 'materials=', $a), $a[$a.length - 1]);
  });
