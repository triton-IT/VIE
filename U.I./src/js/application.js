...
Opal.modules["application/fake_data"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  return $def(self, '$tool_list', function $$tool_list() {
...
Opal.modules["application/experimental_api"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $hash2 = Opal.hash2, $send = Opal.send, $rb_times = Opal.rb_times, $rb_plus = Opal.rb_plus, $truthy = Opal.truthy, $klass = Opal.klass, $def = Opal.def, $eqeq = Opal.eqeq, $hash = Opal.hash, $slice = Opal.slice, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new_default_params,new,merge,[],default_params,each_with_index,box,*,+,text,[]=,touch,send,each_value,key?,atomes,puts,collapse,==,dup,atome,delete,identity_generator,each');
  
  $$('Essentials').$new_default_params($hash2(["list"], {"list": $hash2(["colors", "items", "sort", "height", "width", "margin", "spacing", "view", "listing"], {"colors": ["red", "blue"], "items": $hash2(["color", "size"], {"color": "black", "size": 33}), "sort": "alphabetically", "height": 60, "width": "auto", "margin": 0, "spacing": 3, "view": "data", "listing": $hash2([], {})})}));
  ...
  $send(self, 'new', [$hash2(["post"], {"post": "list"})], function $$1(params){var self = $$1.$$s == null ? this : $$1.$$s, list_style = nil, list_code = nil, list_listing = nil, line_height = nil, line_width = nil, line_margin = nil, line_spacing = nil;
    ...
    return $send(list_listing, 'each_with_index', [], function $$2(item, index){var $a, self = $$2.$$s == null ? this : $$2.$$s, support = nil, code = nil, $ret_or_1 = nil, item_id = nil;
      ...
      support.$text($hash2(["data", "visual"], {"data": item['$[]']("label"), "visual": $hash2(["size"], {"size": 12})}));
      ...
      return $send(support, 'touch', [true], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s;
        ...
        return self.$send(code, item_id)}, {$$s: self});}, {$$s: self});}, {$$s: self});
  (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$initialize', function $$initialize(atomes) {
      ...
      return $send(atomes, 'each_value', [], function $$4(elements){var self = $$4.$$s == null ? this : $$4.$$s;
    ...
    return $def(self, '$duplicate', function $$duplicate(params) {
      var $a, self = this, properties = nil, atome_type = nil, new_id = nil, $ret_or_1 = nil;
      ...
      new_id = ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : (($a = ["id", self.$identity_generator(atome_type)], $send(params, '[]=', $a), $a[$a.length - 1])));
      properties = $hash2(["type"], {"type": atome_type}).$merge(properties);
      properties = $hash2(["id"], {"id": new_id}).$merge(properties);
      properties = $hash2(["renderers"], {"renderers": properties}).$merge(properties);
      properties.$delete("color");
      $send(params['$[]']("remove"), 'each', [], function $$5(particle_to_remove){
        
        if (particle_to_remove == null) particle_to_remove = nil;
        return properties.$delete(particle_to_remove);});
      return $$('Atome').$new($hash(atome_type, properties));
    }, -1);
...
Opal.modules["application/ui_template"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $hash2 = Opal.hash2, $rb_plus = Opal.rb_plus, $rb_times = Opal.rb_times, $send = Opal.send, $def = Opal.def, self = Opal.top, nil = Opal.nil, logo_color = nil, logo = nil;

  Opal.add_stubs('box,grab,display_svg,[],vie_styles,element,+,*,each_with_index,merge,get_icon,id,touch,action_router,matrix,right,data');
  ...
  self.$element($hash2(["id", "data"], {"id": "debug", "data": $hash2(["debug"], {"debug": true})}));
  
  $def(self, '$fill_tool_zone', function $$fill_tool_zone(ids) {
    ...
    return $send(ids, 'each_with_index', [], function $$1(id_found, index){var self = $$1.$$s == null ? this : $$1.$$s, support = nil;
      ...
      return $send(support, 'touch', [true], function $$2(){var self = $$2.$$s == null ? this : $$2.$$s;

        return self.$action_router(id_found)}, {$$s: self});}, {$$s: self});
  });
  
  $def(self, '$create_matrix', function $$create_matrix(id) {
    var self = this, center = nil, modules = nil;

    
    center = self.$grab("center");
    modules = center.$matrix($hash2(["id", "top", "left", "smooth", "columns", "rows", "width", "height", "color", "cells"], {"id": "matrix_cell_" + (id), "top": 0, "left": 0, "smooth": 0, "columns": $hash2(["count"], {"count": 8}), "rows": $hash2(["count"], {"count": 8}), "width": 440, "height": 440, "color": $hash2(["alpha"], {"alpha": 0}), "cells": $hash2(["particles"], {"particles": $hash2(["margin", "smooth", "color", "shadow"], {"margin": 9, "smooth": 3, "color": self.$vie_styles()['$[]']("cell_color"), "shadow": $hash2(["blur", "left", "top", "id", "red", "green", "blue", "alpha"], {"blur": 9, "left": 3, "top": 3, "id": "default_cell_shadow", "red": 0, "green": 0, "blue": 0, "alpha": 0.3})})})}));
    modules.$right(0);
    return modules;
  });
...
Opal.modules["application/communication"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  Opal.add_stubs('controller_listener,send,controller_sender,alert,data,grab');
  ...
  $def(self, '$load_modules', function $$load_modules(module_id) {
...
Opal.modules["application/callbacks"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $send = Opal.send, $hash2 = Opal.hash2, $eqeq = Opal.eqeq, $def = Opal.def, $truthy = Opal.truthy, $rb_divide = Opal.rb_divide, self = Opal.top, nil = Opal.nil;

  Opal.add_stubs('each,text,grab,==,length,body,[],data,set_title,alert,display_svg,materials,delete,tool_list,box,id,/,width,height,svg_fetch');
  ...
  $def(self, '$get_projects_callback', function $$get_projects_callback(msg_body) {
    ...
    $send(msg_body, 'each', [], function $$1(project){var self = $$1.$$s == null ? this : $$1.$$s, content = nil;
  ...
  $def(self, '$get_modules_callback', function $$get_modules_callback(body) {
    ...
    self.$alert("getting_display_svg");
    $send(body, 'each', [], function $$2(module_found){var self = $$2.$$s == null ? this : $$2.$$s, content = nil;
  ...
  return $def(self, '$insert_module_callback', function $$insert_module_callback(module_id) {
    var self = this;

    return $send(self.$grab("selected").$data(), 'each', [], function $$3(module_id_found){var self = $$3.$$s == null ? this : $$3.$$s, module_found = nil, tool_found = nil, tool_color = nil;

      
      if (module_id_found == null) module_id_found = nil;
      module_found = self.$grab(module_id_found);
      $send(module_found.$materials(), 'each', [], function $$4(child_found){var self = $$4.$$s == null ? this : $$4.$$s;
...
Opal.modules["application/matrix_events"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $send = Opal.send, $return_val = Opal.return_val, $eqeq = Opal.eqeq, $hash2 = Opal.hash2, $def = Opal.def, self = Opal.top, nil = Opal.nil;

  Opal.add_stubs('grab,each_with_index,cells,over,detached,attached,touch,cell,puts,data,[]=,alert,[],==,clear_zone,text,wait,drop');
  return $def(self, '$matrix_events', function $$matrix_events(current_matrix) {
    var self = this, inspector = nil;

    
    inspector = self.$grab("inspector");
    return $send(current_matrix.$cells(), 'each_with_index', [], function $$1(module_slot_id, index){var self = $$1.$$s == null ? this : $$1.$$s, module_slot = nil;
      ...
      $send(module_slot, 'over', ["leave"], function $$3(){
        
        module_slot.$detached("cell_over");
        return module_slot.$attached("cell_color");});
      $send(current_matrix.$cell(index), 'touch', ["down"], function $$4(){var $a, self = $$4.$$s == null ? this : $$4.$$s;

        
        self.$puts("down context is: " + (self.$grab("context").$data()));
        return ($a = [0, index], $send(self.$grab("connection").$data(), '[]=', $a), $a[$a.length - 1]);}, {$$s: self});
      $send(current_matrix.$cell(index), 'touch', ["long"], $return_val(nil));
      $send(current_matrix.$cell(index), 'touch', ["up"], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s, source_cell = nil, target_cell = nil, new_connection = nil;

        
        self.$alert("create a decison hub conditioned to the context ");
        ...
        return self.$alert(self.$grab("connection").$data());}, {$$s: self});
      return $send(current_matrix.$cell(index), 'drop', [true], function $$7(event_content){var self = $$7.$$s == null ? this : $$7.$$s;

        
        if (event_content == null) event_content = nil;
        return self.$puts("reveived : " + (event_content));}, {$$s: self});}, {$$s: self});
  })
};

Opal.modules["application/actions"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $truthy = Opal.truthy, $def = Opal.def, $hash2 = Opal.hash2, $rb_lt = Opal.rb_lt, $rb_plus = Opal.rb_plus, $send = Opal.send, $rb_times = Opal.rb_times, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('send,[]=,data,grab,[],puts,controller_sender,<,new,text,+,sort,alert,each,materials,delete,clear_zone,list,vie_styles,*,each_value,tool_list,box,merge,svg_fetch,id,depth,drag,touch,left,top,attach');
  
  
  $def(self, '$action_router', function $$action_router(id_found) {
    var self = this;

    
    self.$send("action_" + (id_found));
    self.$grab("context").$data()['$[]=']("mode", id_found);
    if (!$truthy(self.$grab("debug").$data()['$[]']("debug"))) {
      return nil
    };
    self.$puts("mode activated: " + (self.$grab("context").$data()));
    return self.$puts("function call : action_" + (id_found));
  });
  
  $def(self, '$action_load', function $$action_load() {
    var self = this, a = nil, i = nil, b = nil;

    
    $$('Atome').$controller_sender($hash2(["action"], {"action": "get_projects"}));
    a = self.$grab("inspector");
    i = 0;
    while ($truthy($rb_lt(i, 16))) {
    
      b = $$('Atome').$new($hash2(["shape"], {"shape": $hash2(["renderers", "id", "type", "attach", "attached", "width", "height", "color"], {"renderers": ["browser"], "id": "the_shape" + (i), "type": "shape", "attach": ["inspector"], "attached": [], "width": 50, "height": 50, "color": $hash2(["renderers", "id", "type", "attach", "attached", "red", "green", "blue", "alpha"], {"renderers": ["browser"], "id": "c31", "type": "color", "attach": ["the_shape" + (i)], "attached": [], "red": 1, "green": 0.15, "blue": 0.15, "alpha": 0.6})})}));
      b.$text($hash2(["data", "visual"], {"data": "item" + ($rb_plus(i, 1)), "visual": $hash2(["size"], {"size": 12})}));
      i = $rb_plus(i, 1);
    };
    return $send(a, 'sort', [true], function $$1(el){var self = $$1.$$s == null ? this : $$1.$$s;

      
      if (el == null) el = nil;
      return self.$puts("just sorted  : " + (el));}, {$$s: self});
  });
  ...
  $def(self, '$action_clear', function $$action_clear() {
    ...
    return $send(self.$grab("selected").$data(), 'each', [], function $$2(selected_slot){var self = $$2.$$s == null ? this : $$2.$$s;
      ...
      return $send(self.$grab(selected_slot).$materials(), 'each', [], function $$3(child_found){var self = $$3.$$s == null ? this : $$3.$$s;
  ...
  $def(self, '$action_settings', function $$action_settings() {
    var self = this, inspector = nil, item_to_list = nil;

    
    inspector = self.$grab("inspector");
    self.$clear_zone(inspector);
    item_to_list = [$hash2(["label", "id"], {"label": "module_1", "id": "p1"}), $hash2(["label", "id"], {"label": "module_2", "id": "p2"}), $hash2(["label", "id"], {"label": "module_3", "id": "p3"}), $hash2(["label", "id"], {"label": "module_4", "id": "p4"}), $hash2(["label", "id", "code"], {"label": "module_5", "id": "p5", "code": "test"})];
    $send(inspector, 'sort', [true], function $$4(el){var self = $$4.$$s == null ? this : $$4.$$s;

      
      if (el == null) el = nil;
      return self.$puts("just sorted  : " + (el));}, {$$s: self});
    return self.$grab("inspector").$list($hash2(["listing", "code", "style"], {"listing": item_to_list, "code": "load_modules", "style": $hash2(["colors", "width", "left", "right", "height", "items"], {"colors": ["gray", "white"], "width": "auto", "left": 0, "right": 0, "height": 15, "items": $hash2(["color", "size", "align", "margin"], {"color": "orange", "size": 36, "align": "left", "margin": 3})})}));
  });
  ...
  $def(self, '$action_edition', function $$action_edition() {
    ...
    icon_spacing = $rb_plus(self.$vie_styles()['$[]']("support_style")['$[]']("height"), $rb_times(margin, 2));
    index = 0;
    return $send(self.$tool_list(), 'each_value', [], function $$5(data){var self = $$5.$$s == null ? this : $$5.$$s, icon_found = nil, action_found = nil, id_found = nil, support = nil;
      ...
      $send(support, 'drag', [$hash2(["move"], {"move": true})], function $$6(e){var self = $$6.$$s == null ? this : $$6.$$s;

        
        if (e == null) e = nil;
        return (self.item_moved = true);}, {$$s: self});
      $send(support, 'touch', ["down"], function $$7(){var self = $$7.$$s == null ? this : $$7.$$s, left_found = nil, top_found = nil;
...
;
      ...
      return $send(support, 'touch', ["up"], function $$8(){var self = $$8.$$s == null ? this : $$8.$$s;
...
;
          self.$alert("1 : " + (self.prev_pos_left));
          $send(support, 'drag', [$hash2(["move"], {"move": true})], function $$9(e){var self = $$9.$$s == null ? this : $$9.$$s;
          ...
          self.$alert("moved  is " + (self.item_moved));
        ...
        self.item_moved = false;
        return self.$alert("2 : " + (support.$left()));}, {$$s: self});}, {$$s: self});
  });
...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.3 */
  var $hash2 = Opal.hash2, $send = Opal.send, $truthy = Opal.truthy, $def = Opal.def, self = Opal.top, nil = Opal.nil, default_project_name = nil, current_matrix_id = nil, current_matrix = nil;

  Opal.add_stubs('require,attached,grab,text,merge,[],vie_styles,fill_tool_zone,data,create_matrix,matrix_events,each,materials,delete,detached');
  
  self.$require("application/fake_data.rb");
  ...
  self.$require("application/matrix_events");
  ...
  self.$fill_tool_zone(["load", "clear", "settings", "edition", "select", "group", "copy", "paste", "undo"]);
  current_matrix_id = self.$grab("current_matrix").$data();
  current_matrix = self.$create_matrix(current_matrix_id);
  ...
  $def(self, '$clear_zone', function $$clear_zone(zone) {
    ...
    $send(zone.$materials(), 'each', [], function $$1(child_found){var self = $$1.$$s == null ? this : $$1.$$s;
  ...
  return $def(self, '$remove_active', function $$remove_active(items) {
    var self = this;

    return $send(items, 'each', [], function $$2(id_found, _properties){var self = $$2.$$s == null ? this : $$2.$$s;
