...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.3 */
  var $def = Opal.def, $send = Opal.send, $hash2 = Opal.hash2, $eqeq = Opal.eqeq, $truthy = Opal.truthy, $rb_plus = Opal.rb_plus, $rb_times = Opal.rb_times, $to_ary = Opal.to_ary, $rb_divide = Opal.rb_divide, self = Opal.top, nil = Opal.nil, default_project_name = nil, logo_color = nil, logo = nil;
