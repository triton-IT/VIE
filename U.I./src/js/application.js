...
Opal.modules["application/atome_experimental"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $klass = Opal.klass, $return_val = Opal.return_val, $def = Opal.def, $slice = Opal.slice, self = Opal.top, $nesting = [], nil = Opal.nil;
  ...
  (function($base, $super) {
    ...
    return $def(self, '$<<', $return_val(nil))
  })($nesting[0], null);
...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  $def(self, '$create_matrix', function $$create_matrix(id) {
    ...
    return $send(modules.$children().$value(), 'each_with_index', [], function $$1(_module_found, index){var self = $$1.$$s == null ? this : $$1.$$s;
      ...
      $send(modules.$cell(index), 'touch', ["long"], function $$3(){var self = $$3.$$s == null ? this : $$3.$$s;
        ...
        if ($truthy(self.$grab("selected").$data().$value()['$include?'](self.$id().$value()))) {
          ...
          $send(self.$grab("selected").$data().$value(), 'each', [], function $$4(cell_id){var self = $$4.$$s == null ? this : $$4.$$s, selected_cell = nil;
      ...
      return $send(modules.$cell(index), 'touch', ["up"], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s, source_cell = nil, dest_cell = nil, new_connection = nil;
        ...
        dest_cell = self.$grab("connection").$data().$value()['$[]'](1);
        if ($eqeq(source_cell, dest_cell)) {
          ...
          self.$grab("links").$data()['$[]='](modules.$cell(index).$id().$value(), [source_cell, dest_cell]);
  ...
  $def(self, '$insert_module', function $$insert_module(module_id) {
    ...
    return $send(self.$grab("selected").$data(), 'each', [], function $$17(module_id_found){var self = $$17.$$s == null ? this : $$17.$$s, module_found = nil, tool_found = nil, tool_color = nil;
      ...
      return self.$svg_fetch(tool_found, tool_color, "" + (module_found.$id().$value()) + "_svg_support");}, {$$s: self})
  });
