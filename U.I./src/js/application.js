...
Opal.queue(function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  Opal.add_stubs('require,element,box,[],vie_styles,grab,svg_fetch,text,merge,matrix,detached,width,right,each_with_index,value,children,touch,cell,puts,data,[]=,include?,id,each,attached,<<,==,clear_zone,vivify,wait,create_matrix,set_title,+,*,send,fill_toolzone,delete,children=,top,remove_active,list,project_list,alert,each_value,tool_list,drag,/,height');
