...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.4.0.5")
...
Opal.modules["atome/genesis/generators/utility"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  $send(self, 'new', [$hash2(["particle", "render"], {"particle": "delete", "render": false})], function $$2(params){var user_proc = $$2.$$p || nil, self = $$2.$$s == null ? this : $$2.$$s, id_found = nil, parents_found = nil;
    ...
    if ($eqeq(params, true)) {
      if (($truthy(self.$tag()) && ($truthy(self.$tag()['$[]']("persistent"))))) {
        ...
        return $send(parents_found, 'each', [], function $$4(parent_id_found){var self = $$4.$$s == null ? this : $$4.$$s, parent_found = nil;
          ...
          if ($truthy(parent_found)) {
            ...
            parent_found.$atome()['$[]'](self.$type()).$delete(id_found);
            return parent_found.$atome()['$[]']("attached").$delete(id_found);
          } else {
            return nil
          };}, {$$s: self});
      }
    } else if ($eqeq(params, "materials")) {
      return $send(self.$materials(), 'each', [], function $$5(atome_id_found){var self = $$5.$$s == null ? this : $$5.$$s;
      ...
      return $send(params, 'each', [], function $$6(param, value){var $a, self = $$6.$$s == null ? this : $$6.$$s;
  ...
  $send(self, 'new', [$hash2(["post"], {"post": "clear"})], function $$7(){var self = $$7.$$s == null ? this : $$7.$$s, attached_found = nil;
    if (self.atome == null) self.atome = nil;

    
    attached_found = [];
    $send(self.atome['$[]']("attached"), 'each', [], function $$8(attached_id_found){
      
      if (attached_id_found == null) attached_id_found = nil;
      return attached_found['$<<'](attached_id_found);});
    return $send(attached_found, 'each', [], function $$9(child_id_found){var self = $$9.$$s == null ? this : $$9.$$s, child_found = nil;
  ...
  $send(self, 'new', [$hash2(["particle"], {"particle": "schedule"})], function $$10(date, proc){var self = $$10.$$s == null ? this : $$10.$$s, delimiters = nil, format_date = nil;
    ...
    return $send($$('Universe').$renderer_list(), 'each', [], function $$11(renderer){var self = $$11.$$s == null ? this : $$11.$$s;

      
      if (renderer == null) renderer = nil;
      return $send(self, 'send', ["" + (renderer) + "_schedule", format_date], proc.$to_proc());}, {$$s: self});}, {$$s: self});
  $send(self, 'new', [$hash2(["particle"], {"particle": "read"})], function $$12(file, proc){var self = $$12.$$s == null ? this : $$12.$$s;
  ...
  return $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "batch"})], function $$14(params){
...
Opal.modules["atome/helpers/utilities"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    self.$private();
    $defs(self, '$controller_sender', function $$controller_sender(params) {
