...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.3.9.9")
...
Opal.modules["atome/extensions/atome"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  Opal.add_stubs('generator,key?,build_particle,[],to_proc,build_atome,build_sanitizer,build_option,build_render,counter,atomes,box,grab,circle,matrix,define_method,default_params,send,dispatch');
  return (function($base, $super, $parent_nesting) {
...
Opal.modules["atome/atome"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  Opal.add_stubs('include,private,each_value,[]=,collapse,define_method,==,is_a?,instance_exec,to_proc,sanitize,create_particle,send,[],particle_creation,!,detached,atome_common,run_optional_proc,to_sym,atome_parsing,new,get_optional_method,instance_variable_get,public,attr_accessor,attr_reader,security_pass,store_code_bloc,instance_variable_set,rendering,broadcasting,store_value,connected');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$new_atome', function $$new_atome(element) {
      ...
      return $send($$('Atome'), 'define_method', ["set_" + (element)], function $$5(params){var user_proc = $$5.$$p || nil, new_atome = nil;
...
Opal.modules["atome/helpers/callbacks"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $proto.atome = $proto.drag_start_proc = $proto.drag_move_proc = $proto.drag_end_proc = $proto.drop_action_proc = $proto.sort_proc = $proto.animation_start_proc = $proto.animation_stop_proc = nil;
    ...
    $def(self, '$enter_action_callback', function $$enter_action_callback(proc) {
      var self = this;
    ...
    $def(self, '$leave_action_callback', function $$leave_action_callback(proc) {
      var self = this;
...
Opal.modules["atome/genesis/generators/utility"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  return $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "batch"})], function $$10(params){
...
Opal.modules["atome/helpers/utilities"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $klass = Opal.klass, $send = Opal.send, $def = Opal.def, $return_val = Opal.return_val, $truthy = Opal.truthy, $hash2 = Opal.hash2, $slice = Opal.slice, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('private,each,send,get_sanitizer_method,is_a?,instance_exec,to_proc,instance_variable_get,each_value,include?,[],public,atome,[]=,grab,length,merge,attr_accessor,instance_variable_set,<<,real_atome,property,puts,store_code_bloc,particle_list,delete,collapse,value,each_with_index,instance_of?,new,concat');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
...
Opal.modules["atome/renderers/browser/helpers/event_helper"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  Opal.add_stubs('is_a?,instance_exec,to_proc,on,id,atome_js');
  return (function($base, $parent_nesting) {
    var self = $module($base, 'BrowserHelper');
...
Opal.BrowserHelper.$touch_helper_callback(event,atome,proc);
    ...
    $defs(self, '$browser_over_enter', function $$browser_over_enter(browser_object, atome, proc) {
      ...
      return $send(browser_object, 'on', ["mouseenter"], function $$1(event){var self = $$1.$$s == null ? this : $$1.$$s, atome_id = nil;

        
        if (event == null) event = nil;
        if ($truthy(proc['$is_a?']($$('Proc')))) {
          $send(atome, 'instance_exec', [event], proc.$to_proc())
        };
        atome_id = atome.$id();
        return self.$atome_js().over_enter(atome_id, atome, proc, "enter");}, {$$s: self})
    });
...
Opal.modules["atome/extensions/matrix"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  (function($base, $parent_nesting) {
    ...
    $def(self, '$matrix', function $$matrix(params) {
      ...
      cells_color_id = self.$color(cells_color).$id();
      cells_shadow = cells_data['$[]']("particles").$delete("shadow");
      cells_shadow_id = self.$shadow(cells_shadow).$id();
...
Opal.modules["atome/genesis/sparkle"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  return $$('Atome').$new($hash2(["shape"], {"shape": $hash2(["renderers", "id", "type", "attach", "tag", "attached", "left", "right", "top", "bottom", "width", "height", "overflow"], {"renderers": default_render, "id": "view", "type": "shape", "attach": ["user_view"], "tag": $hash2(["system"], {"system": true}), "attached": "view_color", "left": 0, "right": 0, "top": 0, "bottom": 0, "width": "auto", "height": "auto", "overflow": "auto"})}));
};
