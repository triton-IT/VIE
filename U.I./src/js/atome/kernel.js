Opal.modules["fileutils"] = Opal.return_val(Opal.nil); /* Generated by Opal 1.7.2 */

Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.3.8.1")
  })($nesting[0], null, $nesting)
};

Opal.modules["atome/genesis/genesis"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $klass = Opal.klass, $def = Opal.def, $hash2 = Opal.hash2, $truthy = Opal.truthy, $send = Opal.send, $hash = Opal.hash, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('new,[],nil?,add_to_particle_list,auto_render_generator,new_particle,to_proc,additional_particle_methods,add_to_atome_list,default_params,new_default_params,new_atome,each,renderer_list,build_render,new_render_engine,add_sanitizer_method,to_sym,add_optional_method');
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$build_atome', function $$build_atome(atome_name) {
      ...
      if (!$truthy($$('Essentials').$default_params()['$[]'](atome_name))) {
        $$('Essentials').$new_default_params($hash(atome_name, $hash2(["type", "children", "parents"], {"type": atome_name, "children": [], "parents": ["view"]})))
      };
...
Opal.modules["atome/kernel/essentials"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/kernel/universe"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/kernel/batch"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  Opal.add_stubs('each,value,is_a?,instance_exec,to_proc,[],identity_generator,add_to_atomes,send,dispatch');
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$initialize', function $$initialize(params) {
      ...
      self.id = ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : (self.$identity_generator("batch")));
      $$('Universe').$add_to_atomes(self.id, self);
...
Opal.modules["atome/helpers/essentials"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  return (function($base, $parent_nesting) {
    ...
    self.default_params = $hash2(["render_engines", "collector", "animation", "element", "matrix", "box", "circle", "shape", "text", "drm", "shadow", "color"], {"render_engines": ["browser"], "collector": $hash2(["type", "renderers", "children", "parents"], {"type": "element", "renderers": [], "children": [], "parents": ["black_matter"]}), "animation": $hash2(["type", "children", "parents"], {"type": "animation", "children": [], "parents": ["black_matter"]}), "element": $hash2(["type", "renderers", "children", "parents"], {"type": "element", "renderers": [], "children": [], "parents": ["black_matter"]}), "matrix": $hash2(["renderers", "id", "type", "width", "height", "attached", "children", "left", "top", "clones", "preset", "parents"], {"renderers": [], "id": "", "type": "shape", "width": 99, "height": 99, "attached": ["matrix_color"], "children": [], "left": 100, "top": 100, "clones": [], "preset": "matrix", "parents": ["view"]}), "box": $hash2(["renderers", "id", "type", "width", "height", "attached", "children", "parents", "left", "top", "clones", "preset"], {"renderers": [], "id": "", "type": "shape", "width": 99, "height": 99, "attached": ["box_color"], "children": [], "parents": ["view"], "left": 100, "top": 100, "clones": [], "preset": "box"}), "circle": $hash2(["renderers", "id", "type", "width", "height", "smooth", "attached", "children", "parents", "left", "top", "clones", "preset"], {"renderers": [], "id": "", "type": "shape", "width": 99, "height": 99, "smooth": "100%", "attached": ["circle_color"], "children": [], "parents": ["view"], "left": 100, "top": 100, "clones": [], "preset": "circle"}), "shape": $hash2(["renderers", "id", "type", "width", "height", "attached", "children", "parents", "left", "top", "clones"], {"renderers": [], "id": "", "type": "shape", "width": 99, "height": 99, "attached": ["shape_color"], "children": [], "parents": ["view"], "left": 100, "top": 100, "clones": []}), "text": $hash2(["renderers", "id", "type", "visual", "attached", "children", "parents", "data", "width", "height", "clones"], {"renderers": [], "id": "", "type": "text", "visual": $hash2(["size"], {"size": 25}), "attached": ["text_color"], "children": [], "parents": ["view"], "data": "this is a text sample", "width": 199, "height": 33, "clones": []}), "drm": $hash2(["type", "parents"], {"type": "drm", "parents": ["black_matter"]}), "shadow": $hash2(["parents"], {"parents": ["black_matter"]}), "color": $hash2(["parents"], {"parents": ["black_matter"]})});
...
Opal.modules["atome/renderers/renderer"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/helpers/color_helper/color/rgb/metallic"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/helpers/color_helper/color/rgb/colors"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/helpers/color_helper/color/rgb"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/helpers/color_helper/color/cmyk"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/helpers/color_helper/color/grayscale"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/helpers/color_helper/color/hsl"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/helpers/color_helper/color/yiq"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/helpers/color_helper/color/css"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/helpers/color_helper/color"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/extensions/atome"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $truthy = Opal.truthy, $send = Opal.send, $hash2 = Opal.hash2, $def = Opal.def, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('generator,key?,build_particle,[],to_proc,build_atome,build_sanitizer,build_option,build_render,counter,instance_of?,value,atomes,box,grab,circle,matrix,define_method,default_params,send');
  
  
  $def(self, '$new', function $new$1(params) {
    var bloc = $new$1.$$p || nil, generator = nil;
    ...
    if ($truthy(params['$key?']("particle"))) {
      return $send(generator, 'build_particle', [params['$[]']("particle"), $hash2(["render", "store", "type"], {"render": params['$[]']("render"), "store": params['$[]']("store"), "type": params['$[]']("type")})], bloc.$to_proc())
  ...
  $def(self, '$identity_generator', function $$identity_generator(type) {
    ...
    return "" + (type) + "_" + ($$('Universe').$counter());
  }, -1);
  
  $def(self, '$grab', function $$grab(atome_to_get) {
    
    
    if ($truthy(atome_to_get['$instance_of?']($$('Atome')))) {
      atome_to_get = atome_to_get.$value()
    };
  ...
  return $def(self, '$create_method_at_object_level', function $$create_method_at_object_level(element) {
    ...
    return $send($$('Object'), 'define_method', [element], function $$2(params){var user_proc = $$2.$$p || nil, self = $$2.$$s == null ? this : $$2.$$s, default_parent = nil;
      ...
      default_parent = $$('Essentials').$default_params()['$[]'](element)['$[]']("parents")['$[]'](0);
      return $send(self.$grab(default_parent), 'send', [element, params], user_proc.$to_proc());}, {$$s: self})
  });
};

Opal.modules["atome/extensions/mathematic"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $rb_divide = Opal.rb_divide, $def = Opal.def, $rb_times = Opal.rb_times, $rb_minus = Opal.rb_minus, $rb_plus = Opal.rb_plus, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('instance_of?,value,/,*,-,+');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$/', function $Atome_$slash$1(val) {
      ...
      if ($truthy(val['$instance_of?']($$('Atome')))) {
        val = val.$value()
      };
...
Opal.modules["atome/atome"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  Opal.add_stubs('include,private,each_value,[]=,set_type,[],to_proc,collapse,rendering,define_method,==,is_a?,instance_exec,sanitize,create_particle,send,get_particle,particle_creation,run_optional_proc,to_sym,create_atome,atome_creation_pre_treatment,get_atome,create_method_at_object_level,get_optional_method,instance_variable_get,public,attr_accessor,attr_reader,security_pass,store_code_bloc,instance_variable_set,broadcasting,store_value,new,value=,real_atome=,property=,user_proc=,connected');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$initialize', function $$initialize(atomes) {
      ...
      return $send(atomes, 'each_value', [], function $$1(elements){var self = $$1.$$s == null ? this : $$1.$$s;
        ...
        self.atome = elements;
        $send(self, 'set_type', [self.atome['$[]']("type")], atomes_proc.$to_proc());
        return self.$collapse();}, {$$s: self});
    }, -1);
    
    $def(self, '$set_type', function $$set_type(params) {
      var atomes_proc = $$set_type.$$p || nil, self = this;

      $$set_type.$$p = null;
      
      ;
      return $send(self, 'rendering', ["type", params], atomes_proc.$to_proc());
    });
...
Opal.modules["atome/helpers/callbacks"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/genesis/generators/atome"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $hash2 = Opal.hash2, $send = Opal.send, $eqeq = Opal.eqeq, $truthy = Opal.truthy, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,[],found_parents_and_renderers,==,value,color,detached,delete,grab,identity_generator,instance_of?,create_color_hash,merge!,[]=,atome,default_params,id,merge,shadow,create_shadow_hash,atome_common');
  
  self.$new($hash2(["atome", "type"], {"atome": "color", "type": "hash"}));
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "color"})], function $$1(params){var $a, self = $$1.$$s == null ? this : $$1.$$s, parent_found = nil, render_found = nil, generated_id = nil, $ret_or_1 = nil, default_params = nil, new_params = nil;

    
    if (params == null) params = nil;
    parent_found = self.$found_parents_and_renderers()['$[]']("parent");
    if (!$eqeq(parent_found, ["black_matter"])) {
      if ($truthy(self.$color().$value())) {
        
        self.$detached(self.$color().$value());
        ($a = self.$grab(self.$color().$value()), ($a === nil || $a == null) ? nil : $a.$delete(true));
      }
    };
    render_found = self.$found_parents_and_renderers()['$[]']("renderers");
    generated_id = ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : (self.$identity_generator("color")));
    default_params = $hash2(["renderers", "id", "type", "attach", "red", "green", "blue", "alpha"], {"renderers": render_found, "id": generated_id, "type": "color", "attach": parent_found, "red": 0, "green": 0, "blue": 0, "alpha": 1});
    if (!$truthy(params['$instance_of?']($$('Hash')))) {
      params = self.$create_color_hash(params)
    };
    new_params = default_params['$merge!'](params);
    self.$atome()['$[]=']("color", new_params['$[]']("id"));
    return new_params;}, {$$s: self});
  self.$new($hash2(["atome"], {"atome": "image"}));
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "image"})], function $$2(params){var self = $$2.$$s == null ? this : $$2.$$s, default_renderer = nil, generated_id = nil, $ret_or_1 = nil, generated_render = nil, generated_parents = nil, temp_default = nil;
    ...
    generated_id = ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : (self.$identity_generator("image")));
  ...
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "video"})], function $$3(params){var self = $$3.$$s == null ? this : $$3.$$s, parent_found = nil, render_found = nil, generated_id = nil, $ret_or_1 = nil, default_params = nil;

    
    if (params == null) params = nil;
    parent_found = self.$found_parents_and_renderers()['$[]']("parent");
    render_found = self.$found_parents_and_renderers()['$[]']("renderers");
    generated_id = ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : (self.$identity_generator("video")));
    default_params = $hash2(["renderers", "id", "type", "parents"], {"renderers": render_found, "id": generated_id, "type": "video", "parents": parent_found});
    return default_params['$merge!'](params);}, {$$s: self});
  self.$new($hash2(["atome"], {"atome": "shadow"}));
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "shadow"})], function $$4(params){var $a, self = $$4.$$s == null ? this : $$4.$$s, parent_found = nil, render_found = nil, generated_id = nil, $ret_or_1 = nil, default_params = nil, new_params = nil;
    ...
    if ($eqeq(parent_found, ["view"])) {
      if ($eqeq(parent_found, ["view"])) {
        parent_found = ["black_matter"]
      }
    } else if ($truthy(self.$shadow().$value())) {
      
      self.$detached(self.$shadow().$value());
      ($a = self.$grab(self.$shadow().$value()), ($a === nil || $a == null) ? nil : $a.$delete(true));
    };
    render_found = self.$found_parents_and_renderers()['$[]']("renderers");
    generated_id = ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : (self.$identity_generator("shadow")));
    default_params = $hash2(["renderers", "id", "type", "attach", "red", "green", "blue", "alpha", "blur", "left", "top"], {"renderers": render_found, "id": generated_id, "type": "shadow", "attach": parent_found, "red": 0, "green": 0, "blue": 0, "alpha": 1, "blur": 3, "left": 3, "top": 3});
    if (!$truthy(params['$instance_of?']($$('Hash')))) {
      params = self.$create_shadow_hash(params)
    };
    new_params = default_params['$merge!'](params);
    self.$atome()['$[]=']("shadow", new_params);
    return new_params;}, {$$s: self});
  ...
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "element"})], function $$5(params){var self = $$5.$$s == null ? this : $$5.$$s, parent_found = nil, render_found = nil, generated_id = nil, $ret_or_1 = nil, default_params = nil;

    
    if (params == null) params = nil;
    parent_found = self.$found_parents_and_renderers()['$[]']("parent");
    render_found = [];
    generated_id = ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : (self.$identity_generator("element")));
    default_params = $hash2(["renderers", "id", "type", "parents", "data"], {"renderers": render_found, "id": generated_id, "type": "element", "parents": parent_found, "data": ""});
    return default_params['$merge!'](params);}, {$$s: self});
  self.$new($hash2(["atome"], {"atome": "web"}));
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "web"})], function $$6(params){var self = $$6.$$s == null ? this : $$6.$$s, default_renderer = nil, generated_id = nil, $ret_or_1 = nil, generated_render = nil, generated_parents = nil, temp_default = nil;

    
    if (params == null) params = nil;
    default_renderer = $$('Essentials').$default_params()['$[]']("render_engines");
    generated_id = ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : (self.$identity_generator("web")));
    generated_render = ($truthy(($ret_or_1 = params['$[]']("renderers"))) ? ($ret_or_1) : (default_renderer));
    generated_parents = ($truthy(($ret_or_1 = params['$[]']("parents"))) ? ($ret_or_1) : (self.$id().$value()));
  ...
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "animation"})], function $$7(params){var self = $$7.$$s == null ? this : $$7.$$s, default_renderer = nil, atome_type = nil, generated_render = nil, $ret_or_1 = nil, generated_id = nil, generated_parents = nil, generated_children = nil;
    ...
    generated_render = ($truthy(($ret_or_1 = params['$[]']("renderers"))) ? ($ret_or_1) : (default_renderer));
    generated_id = ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : (self.$identity_generator(atome_type)));
  ...
  return $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "text"})], function $$8(params){var self = $$8.$$s == null ? this : $$8.$$s, default_renderer = nil, atome_type = nil, generated_render = nil, $ret_or_1 = nil, generated_id = nil, generated_parents = nil, generated_children = nil;
...
Opal.modules["atome/presets/atome"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $hash2 = Opal.hash2, $def = Opal.def, $send = Opal.send, $hash = Opal.hash, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('[],default_params,[]=,concat,merge,identity_generator,value,id,atome_common,new,to_proc');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$box', function $$box(params) {
      ...
      atome_type = "box";
      generated_render = ($truthy(($ret_or_1 = params['$[]']("renderers"))) ? ($ret_or_1) : (default_renderer));
      generated_id = ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : (self.$identity_generator("box")));
      generated_parents = ($truthy(($ret_or_1 = params['$[]']("parents"))) ? ($ret_or_1) : ([self.$id().$value()]));
      generated_children = ($truthy(($ret_or_1 = params['$[]']("children"))) ? ($ret_or_1) : ([]));
      params = self.$atome_common(atome_type, generated_id, generated_render, generated_parents, generated_children, params);
    ...
    return $def(self, '$circle', function $$circle(params) {
      ...
      atome_type = "circle";
      generated_render = ($truthy(($ret_or_1 = params['$[]']("renderers"))) ? ($ret_or_1) : (default_renderer));
      generated_id = ($truthy(($ret_or_1 = params['$[]']("id"))) ? ($ret_or_1) : (self.$identity_generator("circle")));
      generated_parents = ($truthy(($ret_or_1 = params['$[]']("parents"))) ? ($ret_or_1) : ([self.$id().$value()]));
      generated_children = ($truthy(($ret_or_1 = params['$[]']("children"))) ? ($ret_or_1) : ([]));
      params = self.$atome_common(atome_type, generated_id, generated_render, generated_parents, generated_children, params);
      return $send($$('Atome'), 'new', [$hash(atome_type, params)], bloc.$to_proc());
...
Opal.modules["atome/genesis/generators/communication"] = Opal.return_val(Opal.nil); /* Generated by Opal 1.7.2 */

Opal.modules["atome/genesis/generators/effect"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/genesis/generators/event"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "drag"})], function $$4(params){
    ...
    return params;});
  $send(self, 'new', [$hash2(["particle"], {"particle": "sort"})], function $$5(_value, sort_proc){var self = $$5.$$s == null ? this : $$5.$$s;
  ...
  $send(self, 'new', [$hash2(["pre"], {"pre": "start"})], function $$6(_value, user_proc){var self = $$6.$$s == null ? this : $$6.$$s;
  ...
  $send(self, 'new', [$hash2(["pre"], {"pre": "stop"})], function $$7(_value, user_proc){var self = $$7.$$s == null ? this : $$7.$$s;
  ...
  self.$new($hash2(["particle"], {"particle": "unbind"}));
  return self.$new($hash2(["particle"], {"particle": "over"}));
};

Opal.modules["atome/genesis/generators/geometry"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/genesis/generators/identity"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  Opal.add_stubs('new,instance_of?,each,value,grab,[],family,[]=,atome,<<,!=,update_atome_id,add_to_atomes,delete,attached,each_with_index,particles,merge,monitor,send');
  
  self.$new($hash2(["particle"], {"particle": "attached"}));
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "attached"})], function $$1(params){
    ...
    return params;});
  $send(self, 'new', [$hash2(["pre"], {"pre": "attached"})], function $$2(children_ids){var self = $$2.$$s == null ? this : $$2.$$s;

    
    if (children_ids == null) children_ids = nil;
    return $send(children_ids, 'each', [], function $$3(child_id){var $a, self = $$3.$$s == null ? this : $$3.$$s, child_found = nil, parents_found = nil;
      if (self.atome == null) self.atome = nil;
  ...
  self.$new($hash2(["particle"], {"particle": "children"}));
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "children"})], function $$4(params){var self = $$4.$$s == null ? this : $$4.$$s, sanitized_params = nil;
    ...
    sanitized_params = [];
    $send(params, 'each', [], function $$5(child_id){var $a, self = $$5.$$s == null ? this : $$5.$$s, child_found = nil, parents_found = nil;
      if (self.atome == null) self.atome = nil;
      ...
      parents_found = self.atome['$[]']("id");
      child_found.$family(parents_found);
      return ($a = ["parents", [parents_found]], $send(child_found.$atome(), '[]=', $a), $a[$a.length - 1]);}, {$$s: self});
    return sanitized_params;}, {$$s: self});
  self.$new($hash2(["particle"], {"particle": "parents"}));
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "parents"})], function $$6(params){var self = $$6.$$s == null ? this : $$6.$$s, sanitized_params = nil;
    ...
    sanitized_params = [];
    $send(params, 'each', [], function $$7(parents_id){var self = $$7.$$s == null ? this : $$7.$$s, parents_found = nil;
      ...
      return parents_found.$atome()['$[]']("children")['$<<'](self.$atome()['$[]']("id"));}, {$$s: self});
    return sanitized_params;}, {$$s: self});
  self.$new($hash2(["particle"], {"particle": "family"}));
  self.$new($hash2(["particle"], {"particle": "link"}));
  self.$new($hash2(["particle"], {"particle": "id"}));
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "id"})], function $$8(params){var self = $$8.$$s == null ? this : $$8.$$s;
    if (self.atome == null) self.atome = nil;
  ...
  $send(self, 'new', [$hash2(["pre"], {"pre": "attach"})], function $$9(parents_ids){var self = $$9.$$s == null ? this : $$9.$$s;

    
    if (parents_ids == null) parents_ids = nil;
    return $send(parents_ids, 'each', [], function $$10(parents_id){var self = $$10.$$s == null ? this : $$10.$$s, parents_found = nil;
  ...
  $send(self, 'new', [$hash2(["particle"], {"particle": "detached"})], function $$11(value){var self = $$11.$$s == null ? this : $$11.$$s;

    
    if (value == null) value = nil;
    return self.$attached().$value().$delete(value);}, {$$s: self});
  self.$new($hash2(["particle", "type"], {"particle": "intricate", "type": "array"}));
  return $send(self, 'new', [$hash2(["particle"], {"particle": "clones"})], function $$12(clones_found){var self = $$12.$$s == null ? this : $$12.$$s;

    
    if (clones_found == null) clones_found = nil;
    return $send(clones_found, 'each_with_index', [], function $$13(clone_found, index){var $a, self = $$13.$$s == null ? this : $$13.$$s, particles_intricated = nil, $ret_or_1 = nil, clone_id = nil, original_id = nil, cloned_atome = nil;
      ...
      return $send(cloned_atome, 'monitor', [$hash2(["atomes", "particles"], {"atomes": [original_id], "particles": particles_intricated})], function $$14(_atome, particle, value){
...
Opal.modules["atome/genesis/generators/material"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $send = Opal.send, $hash2 = Opal.hash2, $truthy = Opal.truthy, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,each,send,puts,particle_to_remove_decision,classes,[],[]=,|,value,id,delete');
  ...
  $send(self, 'new', [$hash2(["particle"], {"particle": "classes"})], function $$9(value){var $a, self = $$9.$$s == null ? this : $$9.$$s, $logical_op_recvr_tmp_1 = nil, $ret_or_1 = nil, $binary_op_recvr_tmp_1 = nil;
    ...
    return ($a = [value, $binary_op_recvr_tmp_1['$[]'](value)['$|']([self.$id().$value()])], $send($binary_op_recvr_tmp_1, '[]=', $a), $a[$a.length - 1]);;}, {$$s: self});
  $send(self, 'new', [$hash2(["particle"], {"particle": "remove_classes"})], function $$10(value){var self = $$10.$$s == null ? this : $$10.$$s;

    
    if (value == null) value = nil;
    return $$('Universe').$classes()['$[]'](value).$delete(self.$id().$value());}, {$$s: self});
  return self.$new($hash2(["particle"], {"particle": "opacity"}));
};

Opal.modules["atome/genesis/generators/spatial"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $send = Opal.send, $hash2 = Opal.hash2, $truthy = Opal.truthy, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,is_a?,instance_exec,to_proc');
  
  $send(self, 'new', [$hash2(["particle"], {"particle": "left"})], function $$1(_params, user_proc){var self = $$1.$$s == null ? this : $$1.$$s;
  ...
  self.$new($hash2(["particle"], {"particle": "right"}));
  self.$new($hash2(["particle"], {"particle": "top"}));
  self.$new($hash2(["particle"], {"particle": "bottom"}));
  self.$new($hash2(["particle"], {"particle": "rotate"}));
  self.$new($hash2(["particle"], {"particle": "direction"}));
  self.$new($hash2(["particle"], {"particle": "center"}));
  return self.$new($hash2(["particle"], {"particle": "depth"}));
};

Opal.modules["atome/genesis/generators/time"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/genesis/generators/utility"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $hash2 = Opal.hash2, $send = Opal.send, $truthy = Opal.truthy, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,[],is_a?,instance_exec,to_proc,==,delete,grab,instance_of?,each,[]=,atome,send,to_s,split,union,renderer_list');
  ...
  self.$new($hash2(["particle"], {"particle": "additional"}));
  $send(self, 'new', [$hash2(["particle"], {"particle": "delete"})], function $$2(params){var self = $$2.$$s == null ? this : $$2.$$s;
    if (self.atome == null) self.atome = nil;
  ...
  $send(self, 'new', [$hash2(["particle"], {"particle": "schedule"})], function $$4(date, proc){var self = $$4.$$s == null ? this : $$4.$$s, delimiters = nil, format_date = nil;
  ...
  $send(self, 'new', [$hash2(["particle"], {"particle": "read"})], function $$6(file, proc){var self = $$6.$$s == null ? this : $$6.$$s;
  ...
  return self.$new($hash2(["particle", "type"], {"particle": "relations", "type": "hash"}));
};

Opal.modules["atome/helpers/utilities"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $klass = Opal.klass, $send = Opal.send, $eqeq = Opal.eqeq, $def = Opal.def, $return_val = Opal.return_val, $truthy = Opal.truthy, $hash2 = Opal.hash2, $hash = Opal.hash, $slice = Opal.slice, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('private,each,==,send,get_sanitizer_method,is_a?,instance_exec,to_proc,instance_variable_get,each_value,include?,[],public,atome,[]=,grab,length,merge,attr_accessor,instance_variable_set,value,<<,real_atome,property,store_code_bloc,puts,particle_list,collapse,identity_generator,id,atome_common,new,each_with_index,class,collector,data,instance_of?');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$add_to_atome', function $$add_to_atome(atome_found, particle_found) {
      var user_proc = $$add_to_atome.$$p || nil, self = this;

      $$add_to_atome.$$p = null;
      
      ;
      self.$puts("we add : " + (particle_found) + " to " + (self.$send(atome_found)) + " ");
      return $send(self, 'send', [atome_found, particle_found, "adder"], user_proc.$to_proc());
    });
    ...
    $def(self, '$include?', function $Atome_include$ques$9(value) {
      ...
      return self.$value()['$include?'](value)
    });
    
    $def(self, '$each_with_index', function $$each_with_index($a) {
      var $post_args, args, $yield = $$each_with_index.$$p || nil, self = this;

      $$each_with_index.$$p = null;
      
      $post_args = $slice(arguments);
      args = $post_args;
      return $send(self.$value(), 'each_with_index', [], function $$10(val, index){
        
        if (val == null) val = nil;
        if (index == null) index = nil;
        return Opal.yieldX($yield, [val, index]);;});
    }, -1);
    
    $def(self, '$[]', function $Atome_$$$11(range) {
      ...
      if ($eqeq(self.$value()['$[]'](range).$class(), $$('Atome'))) {
        ...
        collected_atomes = [];
        $send(self.$value()['$[]'](range), 'each', [], function $$12(atome_found){
    ...
    $def(self, '$[]=', function $Atome_$$$eq$13(params, value) {
      var $a, self = this;

      return ($a = [params, value], $send(self.$value(), '[]=', $a), $a[$a.length - 1])
    });
    ...
    return $def(self, '$particle_to_remove_decision', function $$particle_to_remove_decision(particle_to_remove) {
      var self = this;

      if ($truthy(particle_to_remove['$instance_of?']($$('Hash')))) {
        return $send(particle_to_remove, 'each', [], function $$15(particle_found, value){var self = $$15.$$s == null ? this : $$15.$$s;
...
Opal.modules["atome/renderers/browser/effect"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/event"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/geometry"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/identity"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $send = Opal.send, $eqeq = Opal.eqeq, $neqeq = Opal.neqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;

  Opal.add_stubs('generator,build_render,==,inner_html,sub,id,inner_html=,!=,[],id=,browser_object,send,user_proc,each,remove_class');
  ...
  $send(generator, 'build_render', ["browser_attach"], function $$4(parents_found){var self = $$4.$$s == null ? this : $$4.$$s;
  ...
  return $send(generator, 'build_render', ["browser_detached"], function $$6(value, _user_proc){var self = $$6.$$s == null ? this : $$6.$$s;
    if (self.browser_object == null) self.browser_object = nil;
...
Opal.modules["atome/renderers/browser/material"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/spatial"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $send = Opal.send, $eqeq = Opal.eqeq, $hash2 = Opal.hash2, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;

  Opal.add_stubs('generator,build_render,send,[],==,[]=,style,remove_class,add_class,new');
...
Opal.modules["atome/renderers/browser/atome"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/utility"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/time"] = Opal.return_val(Opal.nil); /* Generated by Opal 1.7.2 */

Opal.modules["atome/renderers/browser/helpers/browser_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/helpers/animation_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/helpers/color_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/helpers/drag_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/helpers/effect_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/helpers/event_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $module = Opal.module, $truthy = Opal.truthy, $send = Opal.send, $defs = Opal.defs, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('is_a?,instance_exec,to_proc,on');
  return (function($base, $parent_nesting) {
    var self = $module($base, 'BrowserHelper');
...
Opal.BrowserHelper.$touch_helper_callback(event,atome,proc);
    ...
    $defs(self, '$browser_over_enter', function $$browser_over_enter(browser_object, atome, proc) {
      
      return $send(browser_object, 'on', ["mouseover"], function $$1(event){
    ...
    return $defs(self, '$browser_over_leave', function $$browser_over_leave(browser_object, atome, proc) {
...
Opal.modules["atome/renderers/browser/helpers/image_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/helpers/shadow_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $module = Opal.module, $send = Opal.send, $rb_times = Opal.rb_times, $defs = Opal.defs, $nesting = [], nil = Opal.nil;
...
Opal.modules["atome/renderers/browser/helpers/shape_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $module = Opal.module, $send = Opal.send, $defs = Opal.defs, $nesting = [], nil = Opal.nil;
...
Opal.modules["atome/renderers/browser/helpers/text_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $module = Opal.module, $send = Opal.send, $defs = Opal.defs, $nesting = [], nil = Opal.nil;
...
Opal.modules["atome/renderers/browser/helpers/video_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/helpers/web_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $module = Opal.module, $send = Opal.send, $defs = Opal.defs, $nesting = [], nil = Opal.nil;
...
Opal.modules["atome/renderers/browser/browser"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/html/effect"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/html/event"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/html/geometry"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $send = Opal.send, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
...
Opal.modules["atome/renderers/html/identity"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $send = Opal.send, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
...
Opal.modules["atome/renderers/html/spatial"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $send = Opal.send, $eqeq = Opal.eqeq, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
...
Opal.modules["atome/renderers/html/atome"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/html/utility"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $send = Opal.send, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
...
Opal.modules["atome/renderers/html/html"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/headless/utility"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/headless/headless"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/server/utility"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil, generator = nil;
...
Opal.modules["atome/renderers/server/server"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var self = Opal.top, nil = Opal.nil;
...
Opal.modules["atome/extensions/matrix"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $module = Opal.module, $truthy = Opal.truthy, $send = Opal.send, $hash2 = Opal.hash2, $def = Opal.def, $rb_times = Opal.rb_times, $rb_divide = Opal.rb_divide, $rb_minus = Opal.rb_minus, $rb_plus = Opal.rb_plus, $hash = Opal.hash, $rb_lt = Opal.rb_lt, $klass = Opal.klass, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('instance_of?,each,content,[],particles,width,height,left,top,[]=,parents,id,collector,grab,<<,data,*,get_column_or_row,is_a?,instance_exec,to_proc,element,merge,/,-,+,each_with_index,value,zero?,length,hide,take,include?,columns,rows,times,children,width=,height=,fusion,divide,set,matrix_sanitizer,delete,color,shadow,default_params,identity_generator,atome_common,new,instance_variable_set,box,attached,apply_style,format_matrix,<,to_a,include');
  ...
  (function($base, $parent_nesting) {
    ...
    $def(self, '$content', function $$content(items) {
      ...
      if (self.cell_content == null) self.cell_content = nil;
...
Opal.modules["atome/helpers/sanitizer"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/genesis/sparkle"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  $$('Atome').$new($hash2(["shape"], {"shape": $hash2(["renderers", "id", "type", "parents", "children", "left", "right", "top", "bottom", "width", "height", "overflow"], {"renderers": default_render, "id": "black_matter", "type": "shape", "parents": ["user_view"], "children": [], "left": 0, "right": 0, "top": 0, "bottom": 0, "width": 0, "height": 0, "overflow": "hidden"})}));
