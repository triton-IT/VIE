...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.3.9.5")
...
Opal.modules["atome/atome"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  Opal.add_stubs('include,private,each_value,[]=,collapse,define_method,==,is_a?,instance_exec,to_proc,sanitize,create_particle,send,get_particle,particle_creation,value,!,[],detached,atome_common,run_optional_proc,to_sym,atome_parsing,get_atome,new,create_method_at_object_level,get_optional_method,instance_variable_get,public,attr_accessor,attr_reader,security_pass,store_code_bloc,instance_variable_set,rendering,broadcasting,store_value,value=,real_atome=,property=,user_proc=,connected');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$atome_parsing', function $$atome_parsing(element, params) {
      ...
      ;
      params = self.$sanitize(element, params);
      current_atome = self.$send(element).$value();
    ...
    $def(self, '$new_atome', function $$new_atome(element) {
      ...
      $send($$('Atome'), 'define_method', ["set_" + (element)], function $$5(params){var user_proc = $$5.$$p || nil, new_atome = nil;
...
Opal.modules["atome/helpers/callbacks"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $proto.atome = $proto.drag_start_proc = $proto.drag_move_proc = $proto.drag_end_proc = $proto.drop_action_proc = $proto.over_action_proc = $proto.sort_proc = $proto.animation_start_proc = $proto.animation_stop_proc = nil;
    ...
    $def(self, '$over_action_callback', function $$over_action_callback(id_found, full_event) {
      var self = this, proc = nil;

      
      proc = self.over_action_proc;
      if ($truthy(proc['$is_a?']($$('Proc')))) {
        return $send(self, 'instance_exec', [$hash2(["id"], {"id": id_found})], proc.$to_proc())
      } else {
        return nil
      };
    });
...
Opal.modules["atome/genesis/generators/atome"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $hash2 = Opal.hash2, $send = Opal.send, $truthy = Opal.truthy, self = Opal.top, $nesting = [], $$ = Opal.$r($nesting), nil = Opal.nil;

  Opal.add_stubs('new,instance_of?,create_color_hash,merge!,merge');
...
Opal.modules["atome/genesis/generators/event"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "over"})], function $$6(params){
...
Opal.modules["atome/genesis/generators/identity"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  Opal.add_stubs('new,instance_of?,value,each,grab,[],atome,[]=,<<,type,detach_atome,!=,update_atome_id,add_to_atomes,each_with_index,particles,merge,monitor,send');
  ...
  $send(self, 'new', [$hash2(["sanitizer"], {"sanitizer": "attached"})], function $$3(children_ids){var self = $$3.$$s == null ? this : $$3.$$s;
    ...
    if ($truthy(children_ids['$instance_of?']($$('Atome')))) {
      children_ids = children_ids.$value()
    };
...
Opal.modules["atome/genesis/generators/utility"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  Opal.add_stubs('new,[],is_a?,instance_exec,to_proc,==,each,detached,grab,delete,materials,instance_of?,[]=,atome,send,to_s,split,union,renderer_list');
  ...
  $send(self, 'new', [$hash2(["particle"], {"particle": "delete"})], function $$2(params){var self = $$2.$$s == null ? this : $$2.$$s, parents_found = nil;
    if (self.atome == null) self.atome = nil;
    ...
    if ($eqeq(params, true)) {
      ...
      $send(parents_found, 'each', [], function $$3(parent_found){var self = $$3.$$s == null ? this : $$3.$$s;
        if (self.atome == null) self.atome = nil;

        
        if (parent_found == null) parent_found = nil;
        return self.$grab(parent_found).$detached(self.atome['$[]']("id"));}, {$$s: self});
      return $$('Universe').$delete(self.atome['$[]']("id"));
    } else if ($eqeq(params, "materials")) {
      return $send(self.$materials(), 'each', [], function $$4(atome_id_found){var self = $$4.$$s == null ? this : $$4.$$s;
  ...
  $send(self, 'new', [$hash2(["particle"], {"particle": "schedule"})], function $$6(date, proc){var self = $$6.$$s == null ? this : $$6.$$s, delimiters = nil, format_date = nil;
  ...
  $send(self, 'new', [$hash2(["particle"], {"particle": "read"})], function $$8(file, proc){var self = $$8.$$s == null ? this : $$8.$$s;

    
    if (file == null) file = nil;
    if (proc == null) proc = nil;
    return $send($$('Universe').$renderer_list(), 'each', [], function $$9(renderer){var self = $$9.$$s == null ? this : $$9.$$s;
...
Opal.modules["atome/helpers/utilities"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $klass = Opal.klass, $send = Opal.send, $def = Opal.def, $return_val = Opal.return_val, $truthy = Opal.truthy, $hash2 = Opal.hash2, $hash = Opal.hash, $slice = Opal.slice, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('private,each,send,get_sanitizer_method,is_a?,instance_exec,to_proc,instance_variable_get,each_value,include?,[],public,atome,[]=,grab,length,merge,attr_accessor,instance_variable_set,value,<<,real_atome,property,puts,store_code_bloc,particle_list,delete,collapse,atome_common,new,each_with_index,instance_of?,collector,data,concat');
  return (function($base, $super, $parent_nesting) {
    var self = $klass($base, $super, 'Atome');
    ...
    $def(self, '$collector', function $$collector(params) {
      var bloc = $$collector.$$p || nil, self = this, atome_type = nil;
    ...
    $def(self, '$[]', function $Atome_$$$10(range) {
      ...
      if ($truthy(self['$instance_of?']($$('Atome')))) {
        ...
        collected_atomes = [];
        $send(self.$value()['$[]'](range), 'each', [], function $$11(atome_found){
    ...
    $def(self, '$[]=', function $Atome_$$$eq$12(params, value) {
      var $a, self = this;
    ...
    $def(self, '$set', function $$set(params) {
      ...
      return $send(params, 'each', [], function $$13(particle, value){var self = $$13.$$s == null ? this : $$13.$$s;
    ...
    $def(self, '$particle_to_remove_decision', function $$particle_to_remove_decision(particle_to_remove) {
      ...
      if ($truthy(particle_to_remove['$instance_of?']($$('Hash')))) {
        return $send(particle_to_remove, 'each', [], function $$14(particle_found, value){var self = $$14.$$s == null ? this : $$14.$$s;
...
Opal.modules["atome/renderers/browser/event"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  $send(generator, 'build_render', ["browser_over"], function $$14(options, proc){var self = $$14.$$s == null ? this : $$14.$$s;

    
    if (options == null) options = nil;
    if (proc == null) proc = nil;
    return $send(options, 'each', [], function $$15(method, params){var self = $$15.$$s == null ? this : $$15.$$s, atome_id = nil;
      if (self.atome == null) self.atome = nil;
      ...
      if (params == null) params = nil;
      atome_id = self.atome['$[]']("id");
      return $$('BrowserHelper').$send("browser_over_" + (method), params, atome_id, self, proc);}, {$$s: self});}, {$$s: self});
  $send(generator, 'build_render', ["browser_sort"], function $$16(options, _proc){var self = $$16.$$s == null ? this : $$16.$$s;
    if (self.atome == null) self.atome = nil;
  ...
  return $send(generator, 'build_render', ["browser_unbind"], function $$17(options, _proc){var self = $$17.$$s == null ? this : $$17.$$s, id_found = nil;
...
Opal.modules["atome/renderers/browser/utility"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  Opal.add_stubs('generator,build_render,==,remove,browser_object,alert,send,[],atome_js,[]=,style');
  ...
  $send(generator, 'build_render', ["browser_clear"], function $$2(){var self = $$2.$$s == null ? this : $$2.$$s;
    ...
    return self.$alert("rewrite code below")}, {$$s: self});
  $send(generator, 'build_render', ["browser_path"], function $$3(value){var self = $$3.$$s == null ? this : $$3.$$s;
    if (self.atome == null) self.atome = nil;
    if (self.browser_object == null) self.browser_object = nil;
  ...
  $send(generator, 'build_render', ["browser_data"], function $$4(data){var self = $$4.$$s == null ? this : $$4.$$s, type_found = nil;
    if (self.atome == null) self.atome = nil;
  ...
  $send(generator, 'build_render', ["browser_schedule"], function $$5(format_date, proc){var self = $$5.$$s == null ? this : $$5.$$s, years = nil, months = nil, days = nil, hours = nil, minutes = nil, seconds = nil;
  ...
  $send(generator, 'build_render', ["browser_reader"], function $$6(file, proc){var self = $$6.$$s == null ? this : $$6.$$s;

    
    if (file == null) file = nil;
    if (proc == null) proc = nil;
    return self.$atome_js().reader(file, self, proc);}, {$$s: self});
  $send(generator, 'build_render', ["browser_cursor"], function $$7(value){var $a, self = $$7.$$s == null ? this : $$7.$$s;
    if (self.browser_object == null) self.browser_object = nil;

    
    if (value == null) value = nil;
    return ($a = ["cursor", value], $send(self.browser_object.$style(), '[]=', $a), $a[$a.length - 1]);}, {$$s: self});
  return $send(generator, 'build_render', ["browser_overflow"], function $$8(value){var $a, self = $$8.$$s == null ? this : $$8.$$s;
    if (self.browser_object == null) self.browser_object = nil;
...
Opal.modules["atome/renderers/browser/helpers/drop_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
...
Opal.modules["atome/renderers/browser/helpers/over_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
  var $module = Opal.module, $defs = Opal.defs, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('over_action_proc=,atome_js');
  return (function($base) {
    var self = $module($base, 'BrowserHelper');

    
    return $defs(self, '$browser_over_action', function $$browser_over_action(params, atome_id, atome, proc) {
      var self = this;

      
      atome['$over_action_proc='](proc);
      return self.$atome_js().over(params, atome_id, atome);
    })
  })($nesting[0])
};
...
Opal.modules["atome/renderers/browser/helpers/text_helper"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  return (function($base, $parent_nesting) {
    ...
    return $defs(self, '$browser_data_scolor', $return_val(nil));
  })($nesting[0], $nesting)
};
...
Opal.modules["atome/renderers/browser/browser"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  self.$require("atome/renderers/browser/helpers/over_helper");
...
Opal.modules["atome/genesis/sparkle"] = function(Opal) {/* Generated by Opal 1.7.2 */
  ...
  Opal.add_stubs('==,downcase,new_default_params,eval,eval_protection,[],default_params,current_user=,puts,aui,mode,current_machine,current_user,current_server,new');
  ...
  self.$puts("application mode:  " + ($$('Atome').$mode()));
  ...
  $$('Atome').$new($hash2(["element"], {"element": $hash2(["renderers", "id", "type"], {"renderers": [], "id": "eDen", "type": "element"})}));
  $$('Atome').$new($hash2(["element"], {"element": $hash2(["renderers", "id", "type", "attach"], {"renderers": [], "id": "user_view", "type": "element", "attach": ["eDen"]})}));
  ...
  $$('Atome').$new($hash2(["shape"], {"shape": $hash2(["renderers", "id", "type", "attach", "left", "right", "top", "bottom", "width", "height", "overflow"], {"renderers": default_render, "id": "black_matter", "type": "shape", "attach": ["user_view"], "left": 0, "right": 0, "top": 0, "bottom": 0, "width": 0, "height": 0, "overflow": "hidden"})}));
  return $$('Atome').$new($hash2(["shape"], {"shape": $hash2(["renderers", "id", "type", "attach", "attached", "left", "right", "top", "bottom", "width", "height", "overflow"], {"renderers": default_render, "id": "view", "type": "shape", "attach": ["user_view"], "attached": "view_color", "left": 0, "right": 0, "top": 0, "bottom": 0, "width": "auto", "height": "auto", "overflow": "auto"})}));
};
