...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.4.1.7")
...
Opal.modules["atome/renderers/browser/opal_add_on"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $def = Opal.def, self = Opal.top, nil = Opal.nil;

  Opal.add_stubs('add_new_class,alert');
  
  
  $def(self, '$add_new_class', function $$add_new_class(class_name, tag_name, tag_content) {
  ...
  self.$add_new_class("new_class", "background-color", "yellow");
  self.$add_new_class("other_class", "color", "red");
  return $def(self, '$update_css_tag', function $$update_css_tag(tag_name, var_name, value) {
    var self = this;

    
    self.$alert("this code doesn't work with chrome");
...
Opal.modules["atome/renderers/browser/material"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  Opal.add_stubs('generator,build_render,*,[]=,[],send,value_parse,style,browser_object,==,attributes,add_class,remove_class,new,id');
...
Opal.modules["atome/renderers/browser/atome"] = function(Opal) {/* Generated by Opal 1.7.3 */
  ...
  Opal.add_stubs('generator,build_render,[],append_to,DOM,atome,div,browser_document,puts,remove,id,*,include?,text,text=,gsub,+,img,iframe,[]=,attributes,video');
  ...
  $send(generator, 'build_render', ["browser_color"], function $$3(_value){var $a, self = $$3.$$s == null ? this : $$3.$$s, id_found = nil, red_found = nil, blue_found = nil, green_found = nil, alpha_found = nil, atomic_style = nil, class_content = nil, regex = nil;
    if (self.atome == null) self.atome = nil;

    
    if (_value == null) _value = nil;
    self.$puts(" @atome[:id] : " + (self.atome['$[]']("id")));
    ...
    class_content = "." + (id_found) + " {\n" + "  background-color: rgba(" + ($rb_times(red_found, 255)) + ", " + ($rb_times(green_found, 255)) + ", " + ($rb_times(blue_found, 255)) + ", " + (alpha_found) + ");\n" + "  fill: rgba(" + ($rb_times(red_found, 255)) + ", " + ($rb_times(green_found, 255)) + ", " + ($rb_times(blue_found, 255)) + ", " + (alpha_found) + ");\n" + "  stroke: rgba(" + ($rb_times(red_found, 255)) + ", " + ($rb_times(green_found, 255)) + ", " + ($rb_times(blue_found, 255)) + ", " + (alpha_found) + ");\n" + "}\n";
...
Opal.modules["atome/renderers/browser/helpers/color_helper"] = function(Opal) {/* Generated by Opal 1.7.3 */
  var $module = Opal.module, $regexp = Opal.regexp, $send = Opal.send, $defs = Opal.defs, $return_val = Opal.return_val, $nesting = [], nil = Opal.nil;

  Opal.add_stubs('[],browser_document,text=,gsub,text,puts');
  return (function($base, $parent_nesting) {
    var self = $module($base, 'BrowserHelper');
    ...
    $defs(self, '$browser_colorize_shadow', function $$browser_colorize_shadow(color_updated, atome) {
      var $a, self = this, left = nil, top = nil, blur = nil, direction = nil, id_found = nil, class_content = nil, atomic_style = nil, regex = nil;

      
      "new shadow color is : " + (color_updated);
      self.$puts("=====> " + (color_updated) + " : " + (atome));
      left = atome['$[]']("left");
      top = atome['$[]']("top");
      blur = atome['$[]']("blur");
