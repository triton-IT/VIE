...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.5.8.2")
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$fit', function $$fit(params) {
      ...
      if ($eqeq(axis, "x")) {
        ...
        return $send(atomes_found, 'each', [], function $$32(atome_id){var self = $$32.$$s == null ? this : $$32.$$s, current_atome = nil;
          ...
          current_atome.$width($rb_times(current_atome.$width(), ratio));
          return current_atome.$height($rb_times(current_atome.$height(), ratio));}, {$$s: self});
      } else {
    ...
    $def(self, '$calculate_total_size', function $$calculate_total_size(objet_atome, axis) {
      ...
      total_size = ($eqeq(axis, "x") ? (objet_atome.$width()) : (objet_atome.$height()));
      max_other_axis_size = ($eqeq(axis, "x") ? (objet_atome.$height()) : (objet_atome.$width()));
      $send(objet_atome.$attached(), 'each', [], function $$35(child_id){var self = $$35.$$s == null ? this : $$35.$$s, child = nil, child_size = nil, other_axis_size = nil;
        ...
        child_size = ($eqeq(axis, "x") ? (child.$width()) : (child.$height()));
        other_axis_size = ($eqeq(axis, "x") ? (child.$height()) : (child.$width()));
    ...
    $def(self, '$resize_and_reposition', function $$resize_and_reposition(objet_atome, scale_factor, axis, max_other_axis_size) {
      ...
      current_position = $rb_plus(current_position, ($eqeq(axis, "x") ? (objet_atome.$width()) : (objet_atome.$height())));
      return $send(objet_atome.$attached(), 'each', [], function $$36(child_id){var self = $$36.$$s == null ? this : $$36.$$s, child = nil;
        ...
        return (current_position = $rb_plus(current_position, child.$height()));}, {$$s: self});
    });
    return $def(self, '$resize_object', function $$resize_object(objet, scale_factor, axis, max_other_axis_size) {
...
Opal.modules["atome/genesis/generators/utility"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return $send(self, 'new', [(new Map([["particle", "compute"]]))], function $$29(params){var $ret_or_1 = nil;
...
Opal.modules["renderers/html/utility"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return $send(self, 'new', [(new Map([["method", "compute"], ["type", "hash"], ["renderer", "html"]]))], function $$17(params){var $a, self = $$17.$$s == null ? this : $$17.$$s, element = nil, bounding_box = nil, top = nil, left = nil, value_found = nil, $ret_or_1 = nil;
    if (self.id == null) self.id = nil;
    ...
    value_found = ($eqeqeq("left", ($ret_or_1 = params['$[]']("particle"))) ? (left.$to_f()) : ($eqeqeq("top", $ret_or_1) ? (top.$to_f()) : (nil)));
