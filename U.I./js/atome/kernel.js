...
Opal.modules["atome/version"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    return $const_set($nesting[0], 'VERSION', "0.5.5.8.1")
  ...
  return (function($base, $super, $parent_nesting) {
    ...
    $def(self, '$console', function $$console(debug) {try { 
      ...
      if ($truthy(debug)) {
        ...
        console = self.$box((new Map([["id", "console"], ["width", "auto"], ["height", 225], ["bottom", 0], ["top", "auto"], ["left", 0], ["right", 0], ["depth", 30], ["color", (new Map([["alpha", 0], ["red", 0.1], ["green", 0.3], ["blue", 0.3]]))]])));
        console_back = console.$box((new Map([["id", "console_back"], ["blur", (new Map([["value", 10], ["affect", "back"]]))], ["overflow", "auto"], ["width", "auto"], ["height", "auto"], ["top", 25], ["bottom", 0], ["left", 0], ["right", 0], ["depth", 30], ["color", (new Map([["alpha", 0.3], ["red", 1], ["green", 1], ["blue", 1]]))]])));
    ...
    $def(self, '$exception_import', function $$exception_import(atome_id) {try { 
      ...
      if ($truthy($$('Universe').$user_atomes()['$include?'](atome_id.$to_sym()))) {
        ...
        return $send($$('JS').$global()['$[]']("document")['$[]']("body"), 'addEventListener', ["drop"], function $$28(native_event){var self = $$28.$$s == null ? this : $$28.$$s, event = nil;
          ...
          event.$preventDefault();
          event.$stopPropagation();
          return self.$puts("Fichier déposé hors de la zone spéciale");}, {$$s: self});
      } else {
        return nil
      };} catch($e) {
        if ($e === Opal.t_eval_return) return $e.$v;
    ...
    return $def(self, '$importer', function $$importer(target) {
...
Opal.modules["atome/genesis/generators/communication"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,instance_of?,connect,html,[],to_proc,[]=,current_user,password,send_message');
...
Opal.modules["atome/genesis/generators/property"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $truthy = Opal.truthy, $def = Opal.def, $send = Opal.send, self = Opal.top, nil = Opal.nil, new$ = nil;
  ...
  $send(self, 'new', [(new Map([["particle", "diffusion"]]))], function $$5(){var self = $$5.$$s == null ? this : $$5.$$s;
    ...
    return self}, {$$s: self});
  return (new$ = self.$new((new Map([["particle", "border"]]))));
};
...
Opal.modules["atome/genesis/generators/spatial"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  $send(self, 'new', [(new Map([["particle", "display"]]))], function $$1(params){
    ...
    return params;});
  return $send(self, 'new', [(new Map([["particle", "layout"]]))], function $$2(params){var self = $$2.$$s == null ? this : $$2.$$s, mode_found = nil, $ret_or_1 = nil, elements_style = nil, atomes_to_organise = nil, container_name = nil, container = nil, container_class = nil, id_found = nil;
...
Opal.modules["atome/genesis/generators/utility"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  return self.$new((new Map([["particle", "import"]])));
};
...
Opal.modules["renderers/html/html"] = function(Opal) {/* Generated by Opal 1.8.2 */
  var $klass = Opal.klass, $truthy = Opal.truthy, $def = Opal.def, $send = Opal.send, $eqeq = Opal.eqeq, $to_ary = Opal.to_ary, $range = Opal.range, $thrower = Opal.thrower, $rb_times = Opal.rb_times, $lambda = Opal.lambda, $rb_plus = Opal.rb_plus, $rb_minus = Opal.rb_minus, $nesting = [], nil = Opal.nil;
...
Opal.modules["renderers/html/property"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,attr,html,update_data,[],*,red,green,blue,alpha,style');
...
Opal.modules["renderers/html/spatial"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,instance_of?,style,html,transform');
  ...
  return $send(self, 'new', [(new Map([["method", "display"], ["renderer", "html"]]))], function $$12(params){var self = $$12.$$s == null ? this : $$12.$$s;
...
Opal.modules["renderers/html/utility"] = function(Opal) {/* Generated by Opal 1.8.2 */
  ...
  Opal.add_stubs('new,delete,html,id,hypertext,hyperedit,read,browse,terminal,===,call,merge,match,==,host,file_for_opal,getElementById,[],global,to_s,createElement,[]=,addEventListener,Native,puts,file_handler,readAsText,click,appendChild,create_file_browser,select_text');
  ...
  return $send(self, 'new', [(new Map([["renderer", "html"], ["method", "selected"], ["specific", "text"]]))], function $$16(value){var bloc = $$16.$$p || nil, self = $$16.$$s == null ? this : $$16.$$s;
