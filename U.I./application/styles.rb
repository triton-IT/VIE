...
def vie_styles
  ...
  # front_color= {red: 0.14, green: 0.13, blue: 0.12}
  {
    ...
    cell_shadow: { blur: 9, left: 3, top: 3, id: :cell_shadow, red: 0, green: 0, blue: 0, alpha: 0.3, direction: :inset },
    invert_shadow: { blur: 9, left: 3, top: 3, id: :invert_shadow, red: 0, green: 0, blue: 0, alpha: 0.3, direction: :inset },
    ...
    inspector_style: { id: :inspector, left: toolbox_with + margin * 2, top: action_height+margin, smooth: smooth, width: inspector_with, bottom: 0, height: 420, overflow: :auto, attached: [:invert_shadow,:inspector_color] },
